...
export type Block = RichTextBlock | ImageBlock | ImageGalleryBlock | ListicleBlock | FacebookPostBlock | InstagramPostBlock | TwitterTweetBlock | VimeoVideoBlock | YouTubeVideoBlock | SoundCloudTrackBlock | PolisConversationBlock | EmbedBlock | LinkPageBreakBlock | TitleBlock | QuoteBlock | TeaserGridBlock;
...
export type ArticleRefFragment = (
  { __typename?: 'Article' }
  & Pick<Article, 'id' | 'publishedAt' | 'updatedAt' | 'tags' | 'preTitle' | 'title' | 'lead'>
  & { image?: Maybe<(
    { __typename?: 'Image' }
    & ImageRefFragment
  )> }
...
export type ArticleQuery = (
  ...
  & { article?: Maybe<(
    { __typename?: 'Article' }
    & Pick<Article, 'id' | 'updatedAt' | 'publishedAt' | 'slug' | 'url' | 'preTitle' | 'title' | 'lead' | 'tags' | 'breaking'>
    & { properties: Array<(
      { __typename?: 'PublicProperties' }
      & Pick<PublicProperties, 'key' | 'value'>
    )>, image?: Maybe<(
      { __typename?: 'Image' }
      & ImageRefFragment
    )>, authors: Array<Maybe<(
...
export type PageRefFragment = (
  { __typename?: 'Page' }
  & Pick<Page, 'id' | 'publishedAt' | 'updatedAt' | 'title' | 'description'>
  & { image?: Maybe<(
    { __typename?: 'Image' }
    & ImageRefFragment
  )> }
...
export type PageQuery = (
  ...
  & { page?: Maybe<(
    { __typename?: 'Page' }
    & Pick<Page, 'id' | 'publishedAt' | 'updatedAt' | 'slug' | 'title' | 'description' | 'tags'>
    & { image?: Maybe<(
      { __typename?: 'Image' }
      & ImageRefFragment
    )>, properties: Array<(
