...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ArticleList(variables?: ArticleListQueryVariables): Promise<ArticleListQuery> {
      return withWrapper(() =>
        client.request<ArticleListQuery>(print(ArticleListDocument), variables)
      )
    },
    PeerArticleList(variables?: PeerArticleListQueryVariables): Promise<PeerArticleListQuery> {
      return withWrapper(() =>
        client.request<PeerArticleListQuery>(print(PeerArticleListDocument), variables)
      )
    },
    CreateArticle(variables: CreateArticleMutationVariables): Promise<CreateArticleMutation> {
      return withWrapper(() =>
        client.request<CreateArticleMutation>(print(CreateArticleDocument), variables)
      )
    },
    UpdateArticle(variables: UpdateArticleMutationVariables): Promise<UpdateArticleMutation> {
      return withWrapper(() =>
        client.request<UpdateArticleMutation>(print(UpdateArticleDocument), variables)
      )
    },
    PublishArticle(variables: PublishArticleMutationVariables): Promise<PublishArticleMutation> {
      return withWrapper(() =>
        client.request<PublishArticleMutation>(print(PublishArticleDocument), variables)
      )
    },
    UnpublishArticle(
      variables: UnpublishArticleMutationVariables
    ): Promise<UnpublishArticleMutation> {
      return withWrapper(() =>
        client.request<UnpublishArticleMutation>(print(UnpublishArticleDocument), variables)
      )
    },
    DeleteArticle(variables: DeleteArticleMutationVariables): Promise<DeleteArticleMutation> {
      return withWrapper(() =>
        client.request<DeleteArticleMutation>(print(DeleteArticleDocument), variables)
      )
    },
    Article(variables: ArticleQueryVariables): Promise<ArticleQuery> {
      return withWrapper(() => client.request<ArticleQuery>(print(ArticleDocument), variables))
    },
    AuthorList(variables?: AuthorListQueryVariables): Promise<AuthorListQuery> {
      return withWrapper(() =>
        client.request<AuthorListQuery>(print(AuthorListDocument), variables)
      )
    },
    Author(variables: AuthorQueryVariables): Promise<AuthorQuery> {
      return withWrapper(() => client.request<AuthorQuery>(print(AuthorDocument), variables))
    },
    CreateAuthor(variables: CreateAuthorMutationVariables): Promise<CreateAuthorMutation> {
      return withWrapper(() =>
        client.request<CreateAuthorMutation>(print(CreateAuthorDocument), variables)
      )
    },
    UpdateAuthor(variables: UpdateAuthorMutationVariables): Promise<UpdateAuthorMutation> {
      return withWrapper(() =>
        client.request<UpdateAuthorMutation>(print(UpdateAuthorDocument), variables)
      )
    },
    DeleteAuthor(variables: DeleteAuthorMutationVariables): Promise<DeleteAuthorMutation> {
      return withWrapper(() =>
        client.request<DeleteAuthorMutation>(print(DeleteAuthorDocument), variables)
      )
    },
    ImageList(variables?: ImageListQueryVariables): Promise<ImageListQuery> {
      return withWrapper(() => client.request<ImageListQuery>(print(ImageListDocument), variables))
    },
    Image(variables: ImageQueryVariables): Promise<ImageQuery> {
      return withWrapper(() => client.request<ImageQuery>(print(ImageDocument), variables))
    },
    UploadImage(variables: UploadImageMutationVariables): Promise<UploadImageMutation> {
      return withWrapper(() =>
        client.request<UploadImageMutation>(print(UploadImageDocument), variables)
      )
    },
    UpdateImage(variables: UpdateImageMutationVariables): Promise<UpdateImageMutation> {
      return withWrapper(() =>
        client.request<UpdateImageMutation>(print(UpdateImageDocument), variables)
      )
    },
    DeleteImage(variables: DeleteImageMutationVariables): Promise<DeleteImageMutation> {
      return withWrapper(() =>
        client.request<DeleteImageMutation>(print(DeleteImageDocument), variables)
      )
    },
    PageList(variables?: PageListQueryVariables): Promise<PageListQuery> {
      return withWrapper(() => client.request<PageListQuery>(print(PageListDocument), variables))
    },
    CreatePage(variables: CreatePageMutationVariables): Promise<CreatePageMutation> {
      return withWrapper(() =>
        client.request<CreatePageMutation>(print(CreatePageDocument), variables)
      )
    },
    UpdatePage(variables: UpdatePageMutationVariables): Promise<UpdatePageMutation> {
      return withWrapper(() =>
        client.request<UpdatePageMutation>(print(UpdatePageDocument), variables)
      )
    },
    PublishPage(variables: PublishPageMutationVariables): Promise<PublishPageMutation> {
      return withWrapper(() =>
        client.request<PublishPageMutation>(print(PublishPageDocument), variables)
      )
    },
    UnpublishPage(variables: UnpublishPageMutationVariables): Promise<UnpublishPageMutation> {
      return withWrapper(() =>
        client.request<UnpublishPageMutation>(print(UnpublishPageDocument), variables)
      )
    },
    DeletePage(variables: DeletePageMutationVariables): Promise<DeletePageMutation> {
      return withWrapper(() =>
        client.request<DeletePageMutation>(print(DeletePageDocument), variables)
      )
    },
    Page(variables: PageQueryVariables): Promise<PageQuery> {
      return withWrapper(() => client.request<PageQuery>(print(PageDocument), variables))
    },
    PeerProfile(variables?: PeerProfileQueryVariables): Promise<PeerProfileQuery> {
      return withWrapper(() =>
        client.request<PeerProfileQuery>(print(PeerProfileDocument), variables)
      )
    },
    UpdatePeerProfile(
      variables: UpdatePeerProfileMutationVariables
    ): Promise<UpdatePeerProfileMutation> {
      return withWrapper(() =>
        client.request<UpdatePeerProfileMutation>(print(UpdatePeerProfileDocument), variables)
      )
    },
    PeerList(variables?: PeerListQueryVariables): Promise<PeerListQuery> {
      return withWrapper(() => client.request<PeerListQuery>(print(PeerListDocument), variables))
    },
    Peer(variables: PeerQueryVariables): Promise<PeerQuery> {
      return withWrapper(() => client.request<PeerQuery>(print(PeerDocument), variables))
    },
    CreatePeer(variables: CreatePeerMutationVariables): Promise<CreatePeerMutation> {
      return withWrapper(() =>
        client.request<CreatePeerMutation>(print(CreatePeerDocument), variables)
      )
    },
    UpdatePeer(variables: UpdatePeerMutationVariables): Promise<UpdatePeerMutation> {
      return withWrapper(() =>
        client.request<UpdatePeerMutation>(print(UpdatePeerDocument), variables)
      )
    },
    DeletePeer(variables: DeletePeerMutationVariables): Promise<DeletePeerMutation> {
      return withWrapper(() =>
        client.request<DeletePeerMutation>(print(DeletePeerDocument), variables)
      )
    }
  }
}
