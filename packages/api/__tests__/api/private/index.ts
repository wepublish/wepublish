...
export type MutationArticleFragment = (
  ...
  & { draft?: Maybe<(
    ...
    { __typename?: 'ArticleRevision' }
    & Pick<ArticleRevision, 'publishedAt' | 'updatedAt' | 'revision' | 'title' | 'preTitle' | 'lead' | 'slug' | 'breaking' | 'tags'>
    & { properties: Array<(
      { __typename?: 'Properties' }
...
export type MutationCommentFragment = (
  { __typename?: 'Comment' }
  & Pick<Comment, 'siteID' | 'userID' | 'permalink' | 'articleID' | 'imageID' | 'peerID' | 'parentID' | 'status' | 'rejectionReason' | 'authorType'>
  & { revisions: Array<Maybe<(
    { __typename?: 'CommentRevision' }
    & Pick<CommentRevision, 'id' | 'text'>
  )>> }
);
