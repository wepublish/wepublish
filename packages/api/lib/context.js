...
const createOptionalsArray = (keys, data, attribute) => {
  ...
  return keys.map(id => {
    var _a
    return (_a = dataMap[id]) !== null && _a !== void 0 ? _a : null
  })
}
...
async function contextFromRequest(
  ...
  const isSessionValid = session
    ? session.type === session_1.SessionType.User
      ...
      : true
    : false
  const peerDataLoader = new dataloader_1.default(async ids =>
  ...
  const loaders = {
    navigationByID: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
    ...
    navigationByKey: new dataloader_1.default(async keys =>
      createOptionalsArray(
        keys,
        await prisma.navigation.findMany({
          where: {
    ...
    authorsByID: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
    ...
    authorsBySlug: new dataloader_1.default(async slugs =>
      createOptionalsArray(
        slugs,
        await prisma.author.findMany({
          where: {
    ...
    images: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
    ...
    articles: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
    ...
    publicArticles: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
        (
          await prisma.article.findMany({
        ...
        ).map(({id, shared, published, pending}) =>
          Object.assign(Object.assign({shared}, published || pending), {id})
        ),
        'id'
      )
    ),
    pages: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
    ...
    publicPagesByID: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
        (
          await prisma.page.findMany({
        ...
        ).map(({id, published, pending}) =>
          Object.assign(Object.assign({}, published || pending), {id})
        ),
        'id'
      )
    ),
    publicPagesBySlug: new dataloader_1.default(async slugs =>
      createOptionalsArray(
        slugs,
        (
          await prisma.page.findMany({
    ...
    userRolesByID: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
    ...
    mailLogsByID: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
    ...
    peer: peerDataLoader,
    peerBySlug: new dataloader_1.default(async slugs =>
      createOptionalsArray(
        slugs,
        await prisma.peer.findMany({
          where: {
      ...
      return Promise.all(
        peers.map(async peer => {
          ...
          try {
            ...
            const peerTimeout =
              ((_a = await prisma.setting.findUnique({
        ...
        peers.map(async peer => {
          ...
          try {
            ...
            const fetcher = createFetcher(
              url_1.default.resolve(peer.hostURL, 'admin'),
              peer.token,
              peerTimeout
            )
            return (0, graphql_tools_1.makeRemoteExecutableSchema)({
    ...
    memberPlansByID: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
    ...
    memberPlansBySlug: new dataloader_1.default(async slugs =>
      createOptionalsArray(
        slugs,
        await prisma.memberPlan.findMany({
          where: {
    ...
    activeMemberPlansByID: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
        await prisma.memberPlan.findMany({
          where: {
    ...
    activeMemberPlansBySlug: new dataloader_1.default(async slugs =>
      createOptionalsArray(
        slugs,
        await prisma.memberPlan.findMany({
          where: {
    ...
    paymentMethodsByID: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
    ...
    activePaymentMethodsByID: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
        await prisma.paymentMethod.findMany({
          where: {
    ...
    activePaymentMethodsBySlug: new dataloader_1.default(async slugs =>
      createOptionalsArray(
        slugs,
        await prisma.paymentMethod.findMany({
          where: {
    ...
    invoicesByID: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
    ...
    paymentsByID: new dataloader_1.default(async ids =>
      createOptionalsArray(
        ids,
    ...
    pollById: new dataloader_1.default(async ids =>
      Promise.all(ids.map(id => (0, poll_public_queries_1.getPoll)(id, prisma.poll)))
    )
  }
  ...
  return {
    ...
    hooks,
    sessionTTL:
      sessionTTL !== null && sessionTTL !== void 0 ? sessionTTL : common_1.DefaultSessionTTL,
    hashCostFactor:
      hashCostFactor !== null && hashCostFactor !== void 0
        ? hashCostFactor
        : common_1.DefaultBcryptHashCostFactor,
      ...
      return {
        errors: [
          new graphql_1.GraphQLError(
            `Peer responded with invalid status: ${
              fetchResult === null || fetchResult === void 0 ? void 0 : fetchResult.status
            }`
          )
        ]
      }
