...
export declare type PollAnswerWithVoteCount = PollAnswer & {
    votes: number;
};
...
export declare enum TeaserType {
    Article = "article",
...
export declare enum TeaserStyle {
    Default = "default",
    Light = "light",
    Text = "text"
}
...
export declare type Teaser = ArticleTeaser | PeerArticleTeaser | PageTeaser | CustomTeaser;
...
export declare type ArticleBlock = RichTextBlock | ImageBlock | ImageGalleryBlock | TitleBlock | QuoteBlock | ListicleBlock | LinkPageBreakBlock | EmbedBlock | HTMLBlock | CommentBlock | PollBlock | FacebookPostBlock | InstagramPostBlock | TwitterTweetBlock | VimeoVideoBlock | YouTubeVideoBlock | SoundCloudTrackBlock | PolisConversationBlock | TikTokVideoBlock | BildwurfAdBlock | TeaserGridBlock | TeaserGridFlexBlock | Prisma.JsonValue;
export declare type PageBlock = ArticleBlock;
export declare type Block = ArticleBlock | PageBlock;
export declare type BlockWithoutJSON = Exclude<ArticleBlock, Prisma.JsonValue>;
export declare type BaseBlockMap = MapDiscriminatedUnion<BlockWithoutJSON, 'type'>;
