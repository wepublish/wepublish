...
export const CanCreateOrganisation: Permission = {
  id: 'CAN_CREATE_ORGANISATION',
  description: 'Allow to create organisation',
  deprecated: false,
}

export const CanGetOrganisations: Permission = {
  id: 'CAN_GET_ORGANISATIONS',
  description: 'Allows to all organisations',
  deprecated: false
}
