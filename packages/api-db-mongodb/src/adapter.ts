...
import {MongoDBOrganisationAdapter} from './db/organisation'
...
export class MongoDBAdapter implements DBAdapter {
  ...
  readonly organisation: MongoDBOrganisationAdapter
  ...
  private constructor({
    ...
    this.organisation = new MongoDBOrganisationAdapter(db, locale)
  }
