...
export function PageEditor({id}: PageEditorProps) {
  ...
  async function handleSave() {
    ...
    if (pageID) {
      ...
      setSuccessMessage(t('pageEditor.overview.pageDraftSaved'))
    } else {
      ...
      setChanged(false)
      setSuccessToastOpen(true)
      setSuccessMessage(t('pageEditor.overview.pageDraftCreated'))
    }
  }
  ...
  async function handlePublish(publishDate: Date, updateDate: Date) {
    ...
    setChanged(false)
    setSuccessToastOpen(true)
    setSuccessMessage(t('pageEditor.overview.pagePublished'))
  }

  useEffect(() => {
    if (isNotFound) {
      setErrorMessage(t('pageEditor.overview.pageNotFound'))
      setErrorToastOpen(true)
    }
  }, [isNotFound])
