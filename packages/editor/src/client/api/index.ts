...
export type FlexGridItemAlignment = {
  __typename?: 'FlexGridItemAlignment'
...
export type FlexTeaser = {
  ...
  alignment: FlexGridItemAlignment
  teaser: Teaser
}
...
> & {
    ...
    latest: {__typename?: 'ArticleRevision'} & Pick<
      ArticleRevision,
      'publishedAt' | 'updatedAt' | 'revision' | 'preTitle' | 'title' | 'lead' | 'canonicalUrl'
    > & {
        authors: Array<Maybe<{__typename?: 'Author'} & Pick<Author, 'name'>>>
...
export type PeerArticleListQuery = {__typename?: 'Query'} & {
  ...
  > & {
      nodes: Array<
        {__typename?: 'PeerArticle'} & Pick<PeerArticle, 'peeredArticleURL'> & {
...
export type DuplicateArticleMutation = {__typename?: 'Mutation'} & {
  duplicateArticle: {__typename?: 'Article'} & MutationArticleFragment
}
...
export type ArticlePreviewLinkQuery = {__typename?: 'Query'} & Pick<Query, 'articlePreviewLink'>
...
export type ArticleQuery = {__typename?: 'Query'} & {
  article?: Maybe<
    {__typename?: 'Article'} & Pick<Article, 'id' | 'shared'> & {
        draft?: Maybe<{__typename?: 'ArticleRevision'} & Pick<ArticleRevision, 'publishAt'>>
...
export type GetAuthProvidersQuery = {__typename?: 'Query'} & {
  authProviders: Array<{__typename?: 'AuthProvider'} & Pick<AuthProvider, 'name' | 'url'>>
}
...
export type CreateSessionWithOAuth2CodeMutation = {__typename?: 'Mutation'} & {
  createSessionWithOAuth2Code: {__typename?: 'SessionWithToken'} & Pick<
    SessionWithToken,
    'token'
  > & {
      user: {__typename?: 'User'} & Pick<User, 'email'> & {
...
export type AuthorRefFragment = {__typename?: 'Author'} & Pick<
  Author,
  'id' | 'name' | 'jobTitle'
> & {image?: Maybe<{__typename?: 'Image'} & ImageRefFragment>}

export type FullAuthorFragment = {__typename?: 'Author'} & Pick<
  Author,
  'slug' | 'bio' | 'createdAt'
> & {
...
type FullBlock_PolisConversationBlock_Fragment = {__typename: 'PolisConversationBlock'} & Pick<
  PolisConversationBlock,
  'conversationID'
>
...
type FullBlock_TeaserFlexGridBlock_Fragment = {__typename: 'TeaserFlexGridBlock'} & {
  flexTeasers: Array<
    Maybe<
      {__typename?: 'FlexTeaser'} & {
        alignment: {__typename?: 'FlexGridItemAlignment'} & Pick<
          FlexGridItemAlignment,
          'i' | 'x' | 'y' | 'w' | 'h' | 'static'
        >
        teaser:
          | ({__typename?: 'ArticleTeaser'} & FullTeaser_ArticleTeaser_Fragment)
...
export type FullParentCommentFragment = {__typename?: 'Comment'} & Pick<
  Comment,
  'id' | 'state' | 'rejectionReason' | 'createdAt' | 'modifiedAt'
> & {
    user: {__typename?: 'User'} & FullUserFragment
    revisions: Array<{__typename?: 'CommentRevision'} & Pick<CommentRevision, 'text' | 'createdAt'>>
  }

export type FullCommentFragment = {__typename?: 'Comment'} & Pick<
  Comment,
  'id' | 'state' | 'rejectionReason' | 'createdAt' | 'modifiedAt'
> & {
    user: {__typename?: 'User'} & FullUserFragment
    revisions: Array<{__typename?: 'CommentRevision'} & Pick<CommentRevision, 'text' | 'createdAt'>>
    parentComment?: Maybe<{__typename?: 'Comment'} & FullParentCommentFragment>
  }
...
export type CommentListQuery = {__typename?: 'Query'} & {
  comments: {__typename?: 'CommentConnection'} & Pick<CommentConnection, 'totalCount'> & {
      nodes: Array<{__typename?: 'Comment'} & FullCommentFragment>
      pageInfo: {__typename?: 'PageInfo'} & Pick<
        PageInfo,
        'startCursor' | 'endCursor' | 'hasNextPage' | 'hasPreviousPage'
      >
...
export type ApproveCommentMutation = {__typename?: 'Mutation'} & {
  approveComment: {__typename?: 'Comment'} & Pick<Comment, 'state'>
}
...
export type RejectCommentMutation = {__typename?: 'Mutation'} & {
  rejectComment: {__typename?: 'Comment'} & Pick<Comment, 'state' | 'rejectionReason'>
}
...
export type RequestChangesOnCommentMutation = {__typename?: 'Mutation'} & {
  requestChangesOnComment: {__typename?: 'Comment'} & Pick<Comment, 'state' | 'rejectionReason'>
}
...
export type MemberPlanRefFragment = {__typename?: 'MemberPlan'} & Pick<
  MemberPlan,
  'id' | 'name' | 'slug' | 'active'
> & {image?: Maybe<{__typename?: 'Image'} & ImageRefFragment>}

export type FullMemberPlanFragment = {__typename?: 'MemberPlan'} & Pick<
  MemberPlan,
  'description' | 'amountPerMonthMin'
> & {
    availablePaymentMethods: Array<
      {__typename?: 'AvailablePaymentMethod'} & Pick<
        AvailablePaymentMethod,
        'paymentPeriodicities' | 'forceAutoRenewal'
      > & {paymentMethods: Array<{__typename?: 'PaymentMethod'} & FullPaymentMethodFragment>}
    >
...
export type MemberPlanListQuery = {__typename?: 'Query'} & {
  memberPlans: {__typename?: 'MemberPlanConnection'} & Pick<MemberPlanConnection, 'totalCount'> & {
      nodes: Array<{__typename?: 'MemberPlan'} & FullMemberPlanFragment>
      pageInfo: {__typename?: 'PageInfo'} & Pick<
        PageInfo,
        'startCursor' | 'endCursor' | 'hasNextPage' | 'hasPreviousPage'
      >
...
export type MemberPlanQuery = {__typename?: 'Query'} & {
  memberPlan?: Maybe<{__typename?: 'MemberPlan'} & FullMemberPlanFragment>
}
...
export type CreateMemberPlanMutation = {__typename?: 'Mutation'} & {
  createMemberPlan?: Maybe<{__typename?: 'MemberPlan'} & FullMemberPlanFragment>
}
...
export type UpdateMemberPlanMutation = {__typename?: 'Mutation'} & {
  updateMemberPlan?: Maybe<{__typename?: 'MemberPlan'} & FullMemberPlanFragment>
}
...
export type DeleteMemberPlanMutation = {__typename?: 'Mutation'} & Pick<
  Mutation,
  'deleteMemberPlan'
>
...
export type DuplicatePageMutation = {__typename?: 'Mutation'} & {
  duplicatePage: {__typename?: 'Page'} & MutationPageFragment
}
...
export type PagePreviewLinkQuery = {__typename?: 'Query'} & Pick<Query, 'pagePreviewLink'>
...
export type PageQuery = {__typename?: 'Query'} & {
  page?: Maybe<
    {__typename?: 'Page'} & Pick<Page, 'id'> & {
        draft?: Maybe<{__typename?: 'PageRevision'} & Pick<PageRevision, 'publishAt'>>
...
export type FullPaymentProviderFragment = {__typename?: 'PaymentProvider'} & Pick<
  PaymentProvider,
  'id' | 'name'
>

export type FullPaymentMethodFragment = {__typename?: 'PaymentMethod'} & Pick<
  PaymentMethod,
  'id' | 'name' | 'createdAt' | 'modifiedAt' | 'description' | 'active'
> & {paymentProvider: {__typename?: 'PaymentProvider'} & FullPaymentProviderFragment}

export type PaymentProviderListQueryVariables = Exact<{[key: string]: never}>

export type PaymentProviderListQuery = {__typename?: 'Query'} & {
  paymentProviders: Array<{__typename?: 'PaymentProvider'} & FullPaymentProviderFragment>
}

export type PaymentMethodListQueryVariables = Exact<{[key: string]: never}>

export type PaymentMethodListQuery = {__typename?: 'Query'} & {
  paymentMethods: Array<{__typename?: 'PaymentMethod'} & FullPaymentMethodFragment>
}
...
export type PaymentMethodQuery = {__typename?: 'Query'} & {
  paymentMethod?: Maybe<{__typename?: 'PaymentMethod'} & FullPaymentMethodFragment>
}
...
export type CreatePaymentMethodMutation = {__typename?: 'Mutation'} & {
  createPaymentMethod?: Maybe<{__typename?: 'PaymentMethod'} & FullPaymentMethodFragment>
}
...
export type UpdatePaymentMethodMutation = {__typename?: 'Mutation'} & {
  updatePaymentMethod?: Maybe<{__typename?: 'PaymentMethod'} & FullPaymentMethodFragment>
}
...
export type PeerRefFragment = {__typename?: 'Peer'} & Pick<
  Peer,
  'id' | 'name' | 'slug' | 'hostURL'
...
export type FullUserSubscriptionFragment = {__typename?: 'UserSubscription'} & Pick<
  UserSubscription,
  'paymentPeriodicity' | 'monthlyAmount' | 'autoRenew' | 'startsAt' | 'paidUntil' | 'deactivatedAt'
> & {
    memberPlan: {__typename?: 'MemberPlan'} & FullMemberPlanFragment
    paymentMethod: {__typename?: 'PaymentMethod'} & FullPaymentMethodFragment
  }
...
> & {
    address?: Maybe<
      ...
      >
    >
    properties: Array<{__typename?: 'Properties'} & Pick<Properties, 'key' | 'value' | 'public'>>
    roles: Array<{__typename?: 'UserRole'} & FullUserRoleFragment>
    subscription?: Maybe<{__typename?: 'UserSubscription'} & FullUserSubscriptionFragment>
  }
...
export type UpdateUserSubscriptionMutation = {__typename?: 'Mutation'} & {
  updateUserSubscription?: Maybe<{__typename?: 'UserSubscription'} & FullUserSubscriptionFragment>
}
...
export type DeleteUserSubscriptionMutation = {__typename?: 'Mutation'} & Pick<
  Mutation,
...
>
export type CreateSessionWithOAuth2CodeMutationResult = Apollo.MutationResult<
  CreateSessionWithOAuth2CodeMutation
>
...
>
export type RequestChangesOnCommentMutationResult = Apollo.MutationResult<
  RequestChangesOnCommentMutation
>
...
export function useUpdateUserSubscriptionMutation(
  ...
  return Apollo.useMutation<
    UpdateUserSubscriptionMutation,
    UpdateUserSubscriptionMutationVariables
  >(UpdateUserSubscriptionDocument, options)
}
export type UpdateUserSubscriptionMutationHookResult = ReturnType<
  typeof useUpdateUserSubscriptionMutation
>
export type UpdateUserSubscriptionMutationResult = Apollo.MutationResult<
  UpdateUserSubscriptionMutation
>
...
export function useDeleteUserSubscriptionMutation(
  ...
  return Apollo.useMutation<
    DeleteUserSubscriptionMutation,
    DeleteUserSubscriptionMutationVariables
  >(DeleteUserSubscriptionDocument, options)
}
export type DeleteUserSubscriptionMutationHookResult = ReturnType<
  typeof useDeleteUserSubscriptionMutation
>
export type DeleteUserSubscriptionMutationResult = Apollo.MutationResult<
  DeleteUserSubscriptionMutation
>
