...
export interface BaseButtonProps<P extends {}> extends ButtonProps {
...
export interface BaseButtonPropsWithCSSProps<P extends {}> extends ButtonProps {
  readonly css?: CSSRule<P> | CSSRule<P>[]
  readonly cssProps: P
}
...
export function BaseButton<P extends {}>(props: BaseButtonPropsWithCSSProps<P>): JSX.Element
export function BaseButton<P extends {}>({
  href,
  css: cssStyles,
  cssProps,
  children,
