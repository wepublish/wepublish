...
import {PAYMENTS_MODULE_OPTIONS, PaymentsModuleOptions} from '@wepublish/payment/api'
...
async function bootstrap() {
  ...
  const paymentProviders =
    nestApp.get<PaymentsModuleOptions>(PAYMENTS_MODULE_OPTIONS).paymentProviders
