...
import {MutationCreateTagArgs, TagType, useCreateTagMutation} from '@wepublish/editor/api'
...
const CheckedPermissionComponent = createCheckedPermissionComponent([CanCreateTag.id])(
  TagCreateView
)
