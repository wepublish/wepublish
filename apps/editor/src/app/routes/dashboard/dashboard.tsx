    ...
    <FlexboxGrid justify="space-between">
      <FlexboxGrid.Item colspan={24}>
        <RPanel
            ...
            <ListViewContainer>
              ...
              <ListViewActions>
                <Link to="/audience/dashboard">
                  <Button appearance="primary" endIcon={<MdChevronRight />}>
          ...
          bordered>
          <AudienceDashboard hideHeader hideFilter initialDateRange="lastWeek" />
        </RPanel>
      </FlexboxGrid.Item>

      <Item colspan={14}>
        <RPanel header={<h2>{t('dashboard.activity')}</h2>} bordered>
          <ActivityFeed />
        </RPanel>
      </Item>
      ...
      <Item colspan={9}>
        <PermissionControl qualifyingPermissions={['CAN_GET_PERIODIC_JOB_LOG']}>
          <RPanel header={<h2>{t('periodicJobsLog.title')}</h2>} bordered>
            <PeriodicJobsLog />
          </RPanel>
        </PermissionControl>
      </Item>
