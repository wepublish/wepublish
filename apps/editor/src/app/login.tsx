...
import {Button, Form as RForm, IconButton as RIconButton, Message, toaster} from 'rsuite'
...
export function Login() {
  ...
  const authenticateUser = useCallback(
    (sessionToken: string, responseEmail: string, userRoles: FullUserRoleFragment[]) => {
