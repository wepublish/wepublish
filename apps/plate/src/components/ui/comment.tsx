...
import {type TDiscussion, discussionPlugin} from '../editor/plugins/discussion-kit'
...
function CommentMoreDropdown(props: {
  ...
  const {comment, dropdownOpen, setDropdownOpen, setEditingId, onCloseAutoFocus, onRemoveComment} =
    props
