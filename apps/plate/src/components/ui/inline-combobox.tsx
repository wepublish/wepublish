...
type InlineComboboxInputProps = HTMLAttributes<HTMLInputElement> & {
  ref?: ForwardedRef<HTMLInputElement>
}

const InlineComboboxInput = ({className, ref: propRef, ...props}: InlineComboboxInputProps) => {
...
function InlineComboboxGroup({className, ...props}: ComponentProps<typeof ComboboxGroup>) {
  return (
    <ComboboxGroup
      {...props}
