...
import {ComponentProps, ReactNode, useState, useCallback, Ref, CSSProperties} from 'react'
...
function TableFloatingToolbar({children, ...props}: ComponentProps<typeof PopoverContent>) {
...
function ColorDropdownMenu({children, tooltip}: {children: ReactNode; tooltip: string}) {
...
export function TableCellHeaderElement(props: ComponentProps<typeof TableCellElement>) {
