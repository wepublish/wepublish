  ...
  return (
    <>
      <Head>
        ...
        <link rel="stylesheet" href="/newsletter/styles.css"></link>
      ...
      <main className="main" style={{backgroundColor: props.mainBackground}}>
        ...
        <div className="pinkblob pinkblob--topright" style={{background: props.blobBackground}} />
        ...
        <div className="pinkblob pinkblob--bottomleft" style={{background: props.blobBackground}} />
        <div
        ...
        <section className="subscribetext" style={{background: props.subscribetextBackground}}>
          <div>{props.subscribe}</div>
        </section>
      </main>
      <footer className="footer" style={{backgroundImage: `url(${props.footerBackgroundImage})`}}>
        {props.signupForm}
      </footer>
    </>
  )
