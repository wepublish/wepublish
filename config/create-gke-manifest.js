...
const NAMESPACE = 'wepublish-dev'

const devDomain = `${GITHUB_REF_SHORT}.wepublish.dev`
const domainCn = `${devDomain}`
const domainSan = `www.${devDomain}`
const domainMedia = `media.${devDomain}`
const domainAPI = `api.${devDomain}`
const domainEditor = `editor.${devDomain}`
                    ...
                    containers: [
                        {
                            ...
                            env: [
                                ...
                                // {
                                //   name: 'CANONICAL_HOST',
                                //   value: 'https://staging.demo.wepublish.media'
                                // },
                                {
                                    name: 'DATABASE_URL',
                                    value: databaseURL
