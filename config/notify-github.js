...
async function main() {
  ...
  - Public API: https://api.${GITHUB_REF_SHORT}.wepublish.dev/v1
  - Privat API: https://api.${GITHUB_REF_SHORT}.wepublish.dev/v1/admin
  - Media: https://media.${GITHUB_REF_SHORT}.wepublish.dev
  - Storybook: https://storybook.${GITHUB_REF_SHORT}.wepublish.dev`
