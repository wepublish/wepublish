import {CommentListDocument, CommentListQuery, FullImageFragment} from '@wepublish/website/api'
...
const comments = [
  verifiedUserComment,
  {...verifiedUserComment, children: nestedChildren, id: '1'},
  {...staffComment, children: nestedChildren, id: '2'},
  {...verifiedUserComment, id: '3'},
  {...anonymousComment, children: nestedChildren, id: '4'},
  {...verifiedUserComment, children: nestedChildren, id: '5'}
