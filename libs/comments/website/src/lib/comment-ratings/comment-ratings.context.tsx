...
import {RateCommentMutation, RateCommentMutationVariables} from '@wepublish/website/api'
...
export type CommentRatingContextProps = Partial<{
  ...
  rate: (
    options: MutationFunctionOptions<RateCommentMutation, RateCommentMutationVariables>
...
export const useCommentRating = () => {
  ...
  const {rate, canRateAnonymously, getAnonymousRate} = useContext(CommentRatingContext)
