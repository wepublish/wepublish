...
import {HOST_URL_TOKEN, JWT_SECRET_KEY_TOKEN, JwtService, WEBSITE_URL_TOKEN} from './jwt.service'
...
export interface SessionModuleAsyncOptions extends Pick<ModuleMetadata, 'imports'> {
  useFactory: (...args: any[]) => Promise<SessionModuleOptions> | SessionModuleOptions
  inject?: any[]
}
...
export class SessionModule {
  ...
  private static createAsyncProviders(options: SessionModuleAsyncOptions): Provider[] {
    return [
      SessionService,
      SessionResolver,
      JwtService,
