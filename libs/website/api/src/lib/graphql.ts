...
export type PublicTrackingPixelFragment = { __typename?: 'TrackingPixel', id: string, trackingPixelProviderType: TrackingPixelProviderType, uri?: string | null };
