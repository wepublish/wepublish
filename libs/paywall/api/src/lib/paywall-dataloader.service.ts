...
export class PaywallDataloaderService implements Primeable<Paywall> {
  ...
  public prime(...parameters: Parameters<DataLoader<string, Paywall | null>['prime']>) {
    return this.dataloader.prime(...parameters)
  }

  public load(...parameters: Parameters<DataLoader<string, Paywall | null>['load']>) {
    return this.dataloader.load(...parameters)
  }

  public loadMany(...parameters: Parameters<DataLoader<string, Paywall | null>['loadMany']>) {
