...
import {BuilderPeerProps, Button, Image, Link, RichTextBlock} from '@wepublish/website/builder'
    ...
    <PeerInformationWrapper className={className}>
      <PeerProfileWrapper className={className}>
        {profile.callToActionImage && (
          <PeerProfileBanner image={profile.callToActionImage} maxWidth={500} />
        )}

        <RichTextBlock richText={information ?? []} css={richTextStyles(theme)} />
