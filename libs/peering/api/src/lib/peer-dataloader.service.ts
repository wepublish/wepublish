...
export class PeerDataloaderService implements Primeable<Peer> {
  ...
  public prime(...parameters: Parameters<DataLoader<string, Peer | null>['prime']>) {
    return this.dataloader.prime(...parameters)
  }

  public load(...parameters: Parameters<DataLoader<string, Peer | null>['load']>) {
    return this.dataloader.load(...parameters)
  }

  public loadMany(...parameters: Parameters<DataLoader<string, Peer | null>['loadMany']>) {
