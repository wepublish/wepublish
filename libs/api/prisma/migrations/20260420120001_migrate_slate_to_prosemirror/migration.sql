...
ALTER TABLE "peerProfiles" ALTER COLUMN "slateCallToActionText" DROP NOT NULL;
...
ALTER TABLE "member.plans" ALTER COLUMN "slateDescription" DROP NOT NULL;
...
ALTER TABLE "paywalls" RENAME COLUMN "upgradeCircumventDescription" to "slateUpgradeCircumventDescription";
ALTER TABLE "paywalls" ADD COLUMN     "upgradeCircumventDescription" JSONB;

ALTER TABLE "paywalls" RENAME COLUMN "upgradeDescription" to "slateUpgradeDescription";
ALTER TABLE "paywalls" ADD COLUMN     "upgradeDescription" JSONB;
