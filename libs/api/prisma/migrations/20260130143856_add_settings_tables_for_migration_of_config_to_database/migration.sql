...
-- CreateEnum
CREATE TYPE "PaymentMethodMollie" AS ENUM ('ALMA', 'APPLEPAY', 'BACS', 'BANCOMATPAY', 'BANCONTACT', 'BANKTRANSFER', 'BELFIUS', 'BILLIE', 'BLIK', 'CREDITCARD', 'DIRECTDEBIT', 'EPS', 'GIFTCARD', 'IDEAL', 'IN3', 'KBC', 'KLARNA', 'KLARNAPAYLATER', 'KLARNAPAYNOW', 'KLARNASLICEIT', 'MYBANK', 'PAYPAL', 'PAYSAFECARD', 'PRZELEWY24', 'RIVERTY', 'SATISPAY', 'TRUSTLY', 'TWINT', 'VOUCHER');
