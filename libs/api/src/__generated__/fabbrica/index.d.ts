...
declare type UserFlowFactoryDefineInput = {
  ...
  accountCreationMailTemplate?:
    | UserFlowaccountCreationMailTemplateFactory
    | Prisma.MailTemplateCreateNestedOneWithoutAccountCreationsInput
  passwordResetMailTemplate?:
    | UserFlowpasswordResetMailTemplateFactory
    | Prisma.MailTemplateCreateNestedOneWithoutPasswordResetsInput
  loginLinkMailTemplate?:
    | UserFlowloginLinkMailTemplateFactory
    | Prisma.MailTemplateCreateNestedOneWithoutLoginLinksInput
}
...
export interface UserFlowFactoryInterface {
  ...
  buildCreateInput(
    inputData?: Partial<Prisma.UserFlowCreateInput>
  ): PromiseLike<Prisma.UserFlowCreateInput>
  buildList(
    inputData: number | readonly Partial<Prisma.UserFlowCreateInput>[]
  ): PromiseLike<Prisma.UserFlowCreateInput[]>
  ...
  createList(
    inputData: number | readonly Partial<Prisma.UserFlowCreateInput>[]
  ): PromiseLike<UserFlow[]>
  createForConnect(
    inputData?: Partial<Prisma.UserFlowCreateInput>
  ): PromiseLike<Pick<UserFlow, 'id'>>
}
/**
 ...
 */
export declare function defineUserFlowFactory(
  options?: UserFlowFactoryDefineOptions
): UserFlowFactoryInterface
...
declare type MailTemplateaccountCreationsFactory = {
  ...
  build: () => PromiseLike<
    Prisma.UserFlowCreateNestedOneWithoutAccountCreationMailTemplateInput['create']
  >
}
declare type MailTemplatepasswordResetsFactory = {
  _factoryFor: 'UserFlow'
  build: () => PromiseLike<
    Prisma.UserFlowCreateNestedOneWithoutPasswordResetMailTemplateInput['create']
  >
}
declare type MailTemplateloginLinksFactory = {
  _factoryFor: 'UserFlow'
  build: () => PromiseLike<
    Prisma.UserFlowCreateNestedOneWithoutLoginLinkMailTemplateInput['create']
  >
}
declare type MailTemplateFactoryDefineInput = {
  ...
  accountCreations?:
    | MailTemplateaccountCreationsFactory
    | Prisma.UserFlowCreateNestedOneWithoutAccountCreationMailTemplateInput
  passwordResets?:
    | MailTemplatepasswordResetsFactory
    | Prisma.UserFlowCreateNestedOneWithoutPasswordResetMailTemplateInput
  loginLinks?:
    | MailTemplateloginLinksFactory
    | Prisma.UserFlowCreateNestedOneWithoutLoginLinkMailTemplateInput
