  ...
  availablePaymentMethods: [
    {
      ...
      paymentMethods: [
        {
          id: '12345',
          description: 'Mit Zahlungsintervall, optionales erneueren',
          name: 'Payrexx',
          slug: 'payrexx',
          paymentProviderID: '1',
          image,
        ...
        {
          id: '12345-12345',
          description: 'Mit Zahlungsintervall, optionales erneueren 2',
          name: 'Payrexx',
          slug: 'payrexx',
          paymentProviderID: '1',
          image,
    ...
    },
    {
      ...
      paymentMethods: [
        {
          id: '1234',
          description: 'Optionales erneueren',
          name: 'Stripe',
          slug: 'stripe',
          paymentProviderID: '2',
          image,
...
const waitForInitialDataIsSet =
  (playFunction: NonNullable<StoryObj['play']>): NonNullable<StoryObj['play']> =>
  async ctx => {
    await wait(100)
...
export const ResetPaymentOptionsOnPaymentMethodChange: StoryObj<typeof Subscribe> = {
  ...LoggedIn,
  play: waitForInitialDataIsSet(async ctx => {
