...
export const PeriodicityPicker = forwardRef<HTMLButtonElement, BuilderPeriodicityPickerProps>(
  function PeriodicityPicker({periodicities, onChange, value, className, name}, ref) {
    const id = useId()
