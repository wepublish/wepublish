...
function SystemMailList() {
  ...
  const {data: mailTemplates} = useMailTemplateQuery(DEFAULT_QUERY_OPTIONS(client))
              ...
              systemMails.systemMails.map(systemMail => (
                <TableRow key={systemMail.event}>
                  ...
                  <TableCell>
                    <SelectPicker
                      ...
                      onSelect={(value: string) =>
                        updateSystemMail({
                          variables: {event: systemMail.event, mailTemplateId: value}
                        })
                      }
                    />
                  </TableCell>
                  ...
                  <TableCell>
                    <Button
                      appearance="default"
                      onClick={() => testSystemMail({variables: {event: systemMail.event}})}>
                      {t('systemMails.test')}
                    </Button>
                  </TableCell>
                </TableRow>
