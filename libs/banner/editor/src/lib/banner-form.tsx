...
import {CheckboxGroup, CheckPicker, Drawer, Form, Panel, Schema, SelectPicker, Toggle} from 'rsuite'
...
type BannerFormData = Omit<CreateBannerInput, 'actions'> & {
      ...
      <Panel bordered style={{overflow: 'initial'}}>
        ...
        <Form.Group controlId="images">
          ...
          <Form.Control
            name="image"
            header={''}
            image={props.banner.imageId}
            disabled={false}
            openChooseModalOpen={() => setChooseModalOpen(true)}
            openEditModalOpen={() => setEditModalOpen(true)}
            removeImage={() => {
              props.onChange({...props.banner, imageId: undefined})
            }}
