...
export function BannerDeleteModal({banner, onClose, onDelete}: DeleteBannerProps) {
  ...
  return (
    <Modal open={!!banner} onClose={onClose}>
      <Modal.Header>
      ...
      <Modal.Footer>
        <Button onClick={deleteBanner} appearance="primary" color="red">
