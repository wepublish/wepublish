...
export class SettingDataloaderService implements Primeable<Setting> {
  private readonly dataloader = new DataLoader<string, Setting | null>(
  ...
  public prime(...parameters: Parameters<DataLoader<string, Setting | null>['prime']>) {
    return this.dataloader.prime(...parameters)
  }

  public load(...parameters: Parameters<DataLoader<string, Setting | null>['load']>) {
    return this.dataloader.load(...parameters)
  }

  public loadMany(...parameters: Parameters<DataLoader<string, Setting | null>['loadMany']>) {
