...
export class CrowdfundingDataloaderService implements Primeable<Crowdfunding> {
  private readonly dataloader = new DataLoader<string, Crowdfunding | null>(
  ...
  public prime(...parameters: Parameters<DataLoader<string, Crowdfunding | null>['prime']>) {
    return this.dataloader.prime(...parameters)
  }

  public load(...parameters: Parameters<DataLoader<string, Crowdfunding | null>['load']>) {
    return this.dataloader.load(...parameters)
  }

  public loadMany(...parameters: Parameters<DataLoader<string, Crowdfunding | null>['loadMany']>) {
