...
type MetadataPropertyArticleRevisionFactory = {
  ...
  build: () => PromiseLike<
    Prisma.ArticleRevisionCreateNestedOneWithoutPropertiesInput['create']
  >;
};
type MetadataPropertyPageRevisionFactory = {
  _factoryFor: 'PageRevision';
  build: () => PromiseLike<
    Prisma.PageRevisionCreateNestedOneWithoutPropertiesInput['create']
  >;
};
type MetadataPropertySubscriptionFactory = {
  _factoryFor: 'Subscription';
  build: () => PromiseLike<
    Prisma.SubscriptionCreateNestedOneWithoutPropertiesInput['create']
  >;
};
type MetadataPropertyUserFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutPropertiesInput['create']
  >;
};
type MetadataPropertyFactoryDefineInput = {
  ...
  User?:
    | MetadataPropertyUserFactory
    | Prisma.UserCreateNestedOneWithoutPropertiesInput;
};
type MetadataPropertyFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<MetadataPropertyFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
type ArticleRevisionimageFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutArticleRevisionImagesInput['create']
  >;
};
...
type ArticleRevisionarticleFactory = {
  _factoryFor: 'Article';
  build: () => PromiseLike<
    Prisma.ArticleCreateNestedOneWithoutRevisionsInput['create']
  >;
};
type ArticleRevisionuserFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutArticleRevisionsInput['create']
  >;
};
type ArticleRevisionFactoryDefineInput = {
  ...
  image?:
    | ArticleRevisionimageFactory
    | Prisma.ImageCreateNestedOneWithoutArticleRevisionImagesInput;
  socialMediaImage?:
    | ArticleRevisionsocialMediaImageFactory
    | Prisma.ImageCreateNestedOneWithoutArticleRevisionSocialMediaImagesInput;
  article:
    | ArticleRevisionarticleFactory
    | Prisma.ArticleCreateNestedOneWithoutRevisionsInput;
  user?:
    | ArticleRevisionuserFactory
    | Prisma.UserCreateNestedOneWithoutArticleRevisionsInput;
};
type ArticleRevisionFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<ArticleRevisionFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
type ArticleRevisionAuthorrevisionFactory = {
  _factoryFor: 'ArticleRevision';
  build: () => PromiseLike<
    Prisma.ArticleRevisionCreateNestedOneWithoutAuthorsInput['create']
  >;
};
type ArticleRevisionAuthorauthorFactory = {
  _factoryFor: 'Author';
  build: () => PromiseLike<
    Prisma.AuthorCreateNestedOneWithoutArticlesAsAuthorInput['create']
  >;
};
...
type ArticleRevisionAuthorFactoryDefineOptions = {
  defaultData: Resolver<
    ArticleRevisionAuthorFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<ArticleRevisionAuthorFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface ArticleRevisionAuthorFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.ArticleRevisionAuthorCreateInput>[]
  ): PromiseLike<Prisma.ArticleRevisionAuthorCreateInput[]>;
  pickForConnect(
...
type ArticleRevisionSocialMediaAuthorFactoryDefineOptions = {
  defaultData: Resolver<
    ArticleRevisionSocialMediaAuthorFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<ArticleRevisionSocialMediaAuthorFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface ArticleRevisionSocialMediaAuthorFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.ArticleRevisionSocialMediaAuthorCreateInput>[]
  ): PromiseLike<Prisma.ArticleRevisionSocialMediaAuthorCreateInput[]>;
  pickForConnect(
...
type ArticlepeerFactory = {
  _factoryFor: 'Peer';
  build: () => PromiseLike<
    Prisma.PeerCreateNestedOneWithoutArticlesInput['create']
  >;
};
...
type ArticleTraitKeys<TOptions extends ArticleFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type ArticleTrackingPixelsarticleFactory = {
  _factoryFor: 'Article';
  build: () => PromiseLike<
    Prisma.ArticleCreateNestedOneWithoutTrackingPixelsInput['create']
  >;
};
type ArticleTrackingPixelstrackingPixelMethodFactory = {
  _factoryFor: 'TrackingPixelMethod';
  build: () => PromiseLike<
    Prisma.TrackingPixelMethodCreateNestedOneWithoutArticleTrackingPixelsInput['create']
  >;
};
type ArticleTrackingPixelsFactoryDefineInput = {
  ...
  error?: string | null;
  article:
    | ArticleTrackingPixelsarticleFactory
    | Prisma.ArticleCreateNestedOneWithoutTrackingPixelsInput;
  trackingPixelMethod:
    | ArticleTrackingPixelstrackingPixelMethodFactory
    | Prisma.TrackingPixelMethodCreateNestedOneWithoutArticleTrackingPixelsInput;
};
type ArticleTrackingPixelsFactoryDefineOptions = {
  defaultData: Resolver<
    ArticleTrackingPixelsFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<ArticleTrackingPixelsFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface ArticleTrackingPixelsFactoryInterfaceWithoutTraits {
  ...
  build(
    inputData?: Partial<Prisma.ArticleTrackingPixelsCreateInput>
  ): PromiseLike<Prisma.ArticleTrackingPixelsCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.ArticleTrackingPixelsCreateInput>
  ): PromiseLike<Prisma.ArticleTrackingPixelsCreateInput>;
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.ArticleTrackingPixelsCreateInput>[]
  ): PromiseLike<Prisma.ArticleTrackingPixelsCreateInput[]>;
  pickForConnect(
    inputData: ArticleTrackingPixels
  ): Pick<ArticleTrackingPixels, 'id'>;
  create(
    inputData?: Partial<Prisma.ArticleTrackingPixelsCreateInput>
  ): PromiseLike<ArticleTrackingPixels>;
  createList(
    inputData:
      | number
      | readonly Partial<Prisma.ArticleTrackingPixelsCreateInput>[]
...
> extends ArticleTrackingPixelsFactoryInterfaceWithoutTraits {
  use(
    ...
    ...names: readonly ArticleTrackingPixelsTraitKeys<TOptions>[]
  ): ArticleTrackingPixelsFactoryInterfaceWithoutTraits;
}
/**
...
type TrackingPixelMethodFactoryDefineOptions = {
  defaultData?: Resolver<
    TrackingPixelMethodFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<TrackingPixelMethodFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface TrackingPixelMethodFactoryInterfaceWithoutTraits {
  ...
  build(
    inputData?: Partial<Prisma.TrackingPixelMethodCreateInput>
  ): PromiseLike<Prisma.TrackingPixelMethodCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.TrackingPixelMethodCreateInput>
  ): PromiseLike<Prisma.TrackingPixelMethodCreateInput>;
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.TrackingPixelMethodCreateInput>[]
  ): PromiseLike<Prisma.TrackingPixelMethodCreateInput[]>;
  pickForConnect(
    inputData: TrackingPixelMethod
  ): Pick<TrackingPixelMethod, 'id'>;
  create(
    inputData?: Partial<Prisma.TrackingPixelMethodCreateInput>
  ): PromiseLike<TrackingPixelMethod>;
  createList(
    inputData:
      | number
      | readonly Partial<Prisma.TrackingPixelMethodCreateInput>[]
...
> extends TrackingPixelMethodFactoryInterfaceWithoutTraits {
  use(
    ...
    ...names: readonly TrackingPixelMethodTraitKeys<TOptions>[]
  ): TrackingPixelMethodFactoryInterfaceWithoutTraits;
}
/**
...
type TaggedArticlesarticleFactory = {
  _factoryFor: 'Article';
  build: () => PromiseLike<
    Prisma.ArticleCreateNestedOneWithoutTagsInput['create']
  >;
};
type TaggedArticlestagFactory = {
  _factoryFor: 'Tag';
  build: () => PromiseLike<
    Prisma.TagCreateNestedOneWithoutArticlesInput['create']
  >;
};
type TaggedArticlesFactoryDefineInput = {
  ...
  modifiedAt?: Date;
  article:
    | TaggedArticlesarticleFactory
    | Prisma.ArticleCreateNestedOneWithoutTagsInput;
...
type TaggedArticlesFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<TaggedArticlesFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface TaggedArticlesFactoryInterfaceWithoutTraits {
  ...
  build(
    inputData?: Partial<Prisma.TaggedArticlesCreateInput>
  ): PromiseLike<Prisma.TaggedArticlesCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.TaggedArticlesCreateInput>
  ): PromiseLike<Prisma.TaggedArticlesCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.TaggedArticlesCreateInput>[]
  ): PromiseLike<Prisma.TaggedArticlesCreateInput[]>;
  pickForConnect(
    inputData: TaggedArticles
  ): Pick<TaggedArticles, 'articleId' | 'tagId'>;
  create(
    inputData?: Partial<Prisma.TaggedArticlesCreateInput>
  ): PromiseLike<TaggedArticles>;
  createList(
    inputData: number | readonly Partial<Prisma.TaggedArticlesCreateInput>[]
  ): PromiseLike<TaggedArticles[]>;
  createForConnect(
...
> extends TaggedArticlesFactoryInterfaceWithoutTraits {
  use(
    ...
    ...names: readonly TaggedArticlesTraitKeys<TOptions>[]
  ): TaggedArticlesFactoryInterfaceWithoutTraits;
}
/**
...
type AuthorsLinksAuthorFactory = {
  _factoryFor: 'Author';
  build: () => PromiseLike<
    Prisma.AuthorCreateNestedOneWithoutLinksInput['create']
  >;
};
type AuthorsLinksFactoryDefineInput = {
  ...
  url?: string;
  Author?:
    | AuthorsLinksAuthorFactory
    | Prisma.AuthorCreateNestedOneWithoutLinksInput;
};
...
type AuthorsLinksTraitKeys<TOptions extends AuthorsLinksFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type AuthorimageFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutAuthorInput['create']
  >;
};
type AuthorpeerFactory = {
  _factoryFor: 'Peer';
  build: () => PromiseLike<
    Prisma.PeerCreateNestedOneWithoutAuthorsInput['create']
  >;
};
...
type AuthorTraitKeys<TOptions extends AuthorFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type TaggedAuthorsauthorFactory = {
  _factoryFor: 'Author';
  build: () => PromiseLike<
    Prisma.AuthorCreateNestedOneWithoutTagsInput['create']
  >;
};
type TaggedAuthorstagFactory = {
  _factoryFor: 'Tag';
  build: () => PromiseLike<
    Prisma.TagCreateNestedOneWithoutAuthorsInput['create']
  >;
};
type TaggedAuthorsFactoryDefineInput = {
  ...
  modifiedAt?: Date;
  author:
    | TaggedAuthorsauthorFactory
    | Prisma.AuthorCreateNestedOneWithoutTagsInput;
...
type TaggedAuthorsFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<TaggedAuthorsFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface TaggedAuthorsFactoryInterfaceWithoutTraits {
  ...
  build(
    inputData?: Partial<Prisma.TaggedAuthorsCreateInput>
  ): PromiseLike<Prisma.TaggedAuthorsCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.TaggedAuthorsCreateInput>
  ): PromiseLike<Prisma.TaggedAuthorsCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.TaggedAuthorsCreateInput>[]
  ): PromiseLike<Prisma.TaggedAuthorsCreateInput[]>;
  pickForConnect(
    inputData: TaggedAuthors
  ): Pick<TaggedAuthors, 'authorId' | 'tagId'>;
  create(
    inputData?: Partial<Prisma.TaggedAuthorsCreateInput>
  ): PromiseLike<TaggedAuthors>;
  createList(
    inputData: number | readonly Partial<Prisma.TaggedAuthorsCreateInput>[]
  ): PromiseLike<TaggedAuthors[]>;
  createForConnect(
...
> extends TaggedAuthorsFactoryInterfaceWithoutTraits {
  use(
    ...
    ...names: readonly TaggedAuthorsTraitKeys<TOptions>[]
  ): TaggedAuthorsFactoryInterfaceWithoutTraits;
}
/**
...
type FocalPointimageFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutFocalPointInput['create']
  >;
};
type FocalPointFactoryDefineInput = {
  ...
  y?: number | null;
  image?:
    | FocalPointimageFactory
    | Prisma.ImageCreateNestedOneWithoutFocalPointInput;
};
...
type FocalPointTraitKeys<TOptions extends FocalPointFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type ImagefocalPointFactory = {
  ...
  build: () => PromiseLike<
    Prisma.FocalPointCreateNestedOneWithoutImageInput['create']
  >;
};
type ImagepeerFactory = {
  _factoryFor: 'Peer';
  build: () => PromiseLike<
    Prisma.PeerCreateNestedOneWithoutImagesInput['create']
  >;
};
type ImageFactoryDefineInput = {
  ...
  width?: number;
  focalPoint?:
    | ImagefocalPointFactory
    | Prisma.FocalPointCreateNestedOneWithoutImageInput;
...
type ImageTraitKeys<TOptions extends ImageFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type CommentsRevisionsCommentFactory = {
  _factoryFor: 'Comment';
  build: () => PromiseLike<
    Prisma.CommentCreateNestedOneWithoutRevisionsInput['create']
  >;
};
type CommentsRevisionsFactoryDefineInput = {
  ...
  lead?: string | null;
  Comment?:
    | CommentsRevisionsCommentFactory
    | Prisma.CommentCreateNestedOneWithoutRevisionsInput;
};
type CommentsRevisionsFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<CommentsRevisionsFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
type CommentguestUserImageFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutCommentInput['create']
  >;
};
type CommentuserFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutCommentsInput['create']
  >;
};
type CommentFactoryDefineInput = {
  ...
  guestUserImage?:
    | CommentguestUserImageFactory
    | Prisma.ImageCreateNestedOneWithoutCommentInput;
...
type CommentTraitKeys<TOptions extends CommentFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type TaggedCommentscommentFactory = {
  _factoryFor: 'Comment';
  build: () => PromiseLike<
    Prisma.CommentCreateNestedOneWithoutTagsInput['create']
  >;
};
type TaggedCommentstagFactory = {
  _factoryFor: 'Tag';
  build: () => PromiseLike<
    Prisma.TagCreateNestedOneWithoutCommentsInput['create']
  >;
};
type TaggedCommentsFactoryDefineInput = {
  ...
  modifiedAt?: Date;
  comment:
    | TaggedCommentscommentFactory
    | Prisma.CommentCreateNestedOneWithoutTagsInput;
...
type TaggedCommentsFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<TaggedCommentsFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface TaggedCommentsFactoryInterfaceWithoutTraits {
  ...
  pickForConnect(
    inputData: TaggedComments
  ): Pick<TaggedComments, 'commentId' | 'tagId'>;
  create(
    inputData?: Partial<Prisma.TaggedCommentsCreateInput>
...
type CommentRatingSystemFactoryDefineOptions = {
  defaultData?: Resolver<
    CommentRatingSystemFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<CommentRatingSystemFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface CommentRatingSystemFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.CommentRatingSystemCreateInput>[]
  ): PromiseLike<Prisma.CommentRatingSystemCreateInput[]>;
  pickForConnect(
    inputData: CommentRatingSystem
  ): Pick<CommentRatingSystem, 'id'>;
  create(
    inputData?: Partial<Prisma.CommentRatingSystemCreateInput>
...
type CommentRatingSystemAnswerratingSystemFactory = {
  ...
  build: () => PromiseLike<
    Prisma.CommentRatingSystemCreateNestedOneWithoutAnswersInput['create']
  >;
};
...
type CommentRatingSystemAnswerFactoryDefineOptions = {
  defaultData: Resolver<
    CommentRatingSystemAnswerFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<CommentRatingSystemAnswerFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface CommentRatingSystemAnswerFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.CommentRatingSystemAnswerCreateInput>[]
  ): PromiseLike<Prisma.CommentRatingSystemAnswerCreateInput[]>;
  pickForConnect(
    inputData: CommentRatingSystemAnswer
...
type CommentRatinguserFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutCommentRatingsInput['create']
  >;
};
...
type CommentRatingcommentFactory = {
  _factoryFor: 'Comment';
  build: () => PromiseLike<
    Prisma.CommentCreateNestedOneWithoutRatingsInput['create']
  >;
};
type CommentRatingFactoryDefineInput = {
  ...
  disabled?: boolean;
  user?:
    | CommentRatinguserFactory
    | Prisma.UserCreateNestedOneWithoutCommentRatingsInput;
  answer:
    | CommentRatinganswerFactory
    | Prisma.CommentRatingSystemAnswerCreateNestedOneWithoutRatingsInput;
  comment:
    | CommentRatingcommentFactory
    | Prisma.CommentCreateNestedOneWithoutRatingsInput;
};
type CommentRatingFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<CommentRatingFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
type CommentRatingOverridecommentFactory = {
  _factoryFor: 'Comment';
  build: () => PromiseLike<
    Prisma.CommentCreateNestedOneWithoutOverriddenRatingsInput['create']
  >;
};
...
type CommentRatingOverrideFactoryDefineOptions = {
  defaultData: Resolver<
    CommentRatingOverrideFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<CommentRatingOverrideFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface CommentRatingOverrideFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.CommentRatingOverrideCreateInput>[]
  ): PromiseLike<Prisma.CommentRatingOverrideCreateInput[]>;
  pickForConnect(
...
type InvoiceIteminvoicesFactory = {
  _factoryFor: 'Invoice';
  build: () => PromiseLike<
    Prisma.InvoiceCreateNestedOneWithoutItemsInput['create']
  >;
};
type InvoiceItemFactoryDefineInput = {
  ...
  amount?: number;
  invoices?:
    | InvoiceIteminvoicesFactory
    | Prisma.InvoiceCreateNestedOneWithoutItemsInput;
};
...
type InvoiceItemTraitKeys<TOptions extends InvoiceItemFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type InvoicesubscriptionFactory = {
  _factoryFor: 'Subscription';
  build: () => PromiseLike<
    Prisma.SubscriptionCreateNestedOneWithoutInvoicesInput['create']
  >;
};
type InvoiceFactoryDefineInput = {
  ...
  subscription?:
    | InvoicesubscriptionFactory
    | Prisma.SubscriptionCreateNestedOneWithoutInvoicesInput;
...
type InvoiceTraitKeys<TOptions extends InvoiceFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type MailLogrecipientFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutMailSentInput['create']
  >;
};
type MailLogmailTemplateFactory = {
  _factoryFor: 'MailTemplate';
  build: () => PromiseLike<
    Prisma.MailTemplateCreateNestedOneWithoutMailLogInput['create']
  >;
};
type MailLogFactoryDefineInput = {
  ...
  subject?: string | null;
  recipient:
    | MailLogrecipientFactory
    | Prisma.UserCreateNestedOneWithoutMailSentInput;
  mailTemplate:
    | MailLogmailTemplateFactory
    | Prisma.MailTemplateCreateNestedOneWithoutMailLogInput;
};
...
type MailLogTraitKeys<TOptions extends MailLogFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type AvailablePaymentMethodFactoryDefineOptions = {
  defaultData?: Resolver<
    AvailablePaymentMethodFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<AvailablePaymentMethodFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface AvailablePaymentMethodFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.AvailablePaymentMethodCreateInput>[]
  ): PromiseLike<Prisma.AvailablePaymentMethodCreateInput[]>;
  pickForConnect(
    inputData: AvailablePaymentMethod
  ): Pick<AvailablePaymentMethod, 'id'>;
  create(
    inputData?: Partial<Prisma.AvailablePaymentMethodCreateInput>
...
type MemberPlanmigrateToTargetPaymentMethodFactory = {
  ...
  build: () => PromiseLike<
    Prisma.PaymentMethodCreateNestedOneWithoutMigrateFromPlansInput['create']
  >;
};
type MemberPlanimageFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutMemberPlanInput['create']
  >;
};
type MemberPlansuccessPageFactory = {
  _factoryFor: 'Page';
  build: () => PromiseLike<
    Prisma.PageCreateNestedOneWithoutMemberPlansSuccessInput['create']
  >;
};
type MemberPlanfailPageFactory = {
  _factoryFor: 'Page';
  build: () => PromiseLike<
    Prisma.PageCreateNestedOneWithoutMemberPlansFailInput['create']
  >;
};
type MemberPlanconfirmationPageFactory = {
  _factoryFor: 'Page';
  build: () => PromiseLike<
    Prisma.PageCreateNestedOneWithoutMemberPlansConfirmationInput['create']
  >;
};
type MemberPlanFactoryDefineInput = {
  ...
  migrateToTargetPaymentMethod?:
    | MemberPlanmigrateToTargetPaymentMethodFactory
    | Prisma.PaymentMethodCreateNestedOneWithoutMigrateFromPlansInput;
  image?:
    | MemberPlanimageFactory
    | Prisma.ImageCreateNestedOneWithoutMemberPlanInput;
  successPage?:
    | MemberPlansuccessPageFactory
    | Prisma.PageCreateNestedOneWithoutMemberPlansSuccessInput;
  failPage?:
    | MemberPlanfailPageFactory
    | Prisma.PageCreateNestedOneWithoutMemberPlansFailInput;
  confirmationPage?:
    | MemberPlanconfirmationPageFactory
    | Prisma.PageCreateNestedOneWithoutMemberPlansConfirmationInput;
...
type MemberPlanTraitKeys<TOptions extends MemberPlanFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type NavigationLinkpageFactory = {
  _factoryFor: 'Page';
  build: () => PromiseLike<
    Prisma.PageCreateNestedOneWithoutNavigationsInput['create']
  >;
};
type NavigationLinkarticleFactory = {
  _factoryFor: 'Article';
  build: () => PromiseLike<
    Prisma.ArticleCreateNestedOneWithoutNavigationsInput['create']
  >;
};
type NavigationLinknavigationFactory = {
  _factoryFor: 'Navigation';
  build: () => PromiseLike<
    Prisma.NavigationCreateNestedOneWithoutLinksInput['create']
  >;
};
type NavigationLinkFactoryDefineInput = {
  ...
  url?: string | null;
  page?:
    | NavigationLinkpageFactory
    | Prisma.PageCreateNestedOneWithoutNavigationsInput;
  article?:
    | NavigationLinkarticleFactory
    | Prisma.ArticleCreateNestedOneWithoutNavigationsInput;
  navigation?:
    | NavigationLinknavigationFactory
    | Prisma.NavigationCreateNestedOneWithoutLinksInput;
};
type NavigationLinkFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<NavigationLinkFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
type NavigationTraitKeys<TOptions extends NavigationFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type PageRevisionimageFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutPageRevisionImagesInput['create']
  >;
};
...
type PageRevisionpageFactory = {
  _factoryFor: 'Page';
  build: () => PromiseLike<
    Prisma.PageCreateNestedOneWithoutRevisionsInput['create']
  >;
};
type PageRevisionuserFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutPageRevisionsInput['create']
  >;
};
type PageRevisionFactoryDefineInput = {
  ...
  image?:
    | PageRevisionimageFactory
    | Prisma.ImageCreateNestedOneWithoutPageRevisionImagesInput;
  socialMediaImage?:
    | PageRevisionsocialMediaImageFactory
    | Prisma.ImageCreateNestedOneWithoutPageRevisionSocialMediaImagesInput;
  page:
    | PageRevisionpageFactory
    | Prisma.PageCreateNestedOneWithoutRevisionsInput;
  user?:
    | PageRevisionuserFactory
    | Prisma.UserCreateNestedOneWithoutPageRevisionsInput;
};
...
type PageRevisionTraitKeys<TOptions extends PageRevisionFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type PageTraitKeys<TOptions extends PageFactoryDefineOptions> =
  keyof TOptions['traits'];
export interface PageFactoryInterfaceWithoutTraits {
  readonly _factoryFor: 'Page';
  build(
    inputData?: Partial<Prisma.PageCreateInput>
...
type TaggedPagespageFactory = {
  _factoryFor: 'Page';
  build: () => PromiseLike<
    Prisma.PageCreateNestedOneWithoutTagsInput['create']
  >;
};
type TaggedPagestagFactory = {
  _factoryFor: 'Tag';
  build: () => PromiseLike<
    Prisma.TagCreateNestedOneWithoutPagesInput['create']
  >;
};
...
type TaggedPagesTraitKeys<TOptions extends TaggedPagesFactoryDefineOptions> =
  keyof TOptions['traits'];
export interface TaggedPagesFactoryInterfaceWithoutTraits {
  readonly _factoryFor: 'TaggedPages';
  build(
    inputData?: Partial<Prisma.TaggedPagesCreateInput>
  ): PromiseLike<Prisma.TaggedPagesCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.TaggedPagesCreateInput>
  ): PromiseLike<Prisma.TaggedPagesCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.TaggedPagesCreateInput>[]
  ): PromiseLike<Prisma.TaggedPagesCreateInput[]>;
  pickForConnect(inputData: TaggedPages): Pick<TaggedPages, 'pageId' | 'tagId'>;
  create(
    inputData?: Partial<Prisma.TaggedPagesCreateInput>
  ): PromiseLike<TaggedPages>;
  createList(
    inputData: number | readonly Partial<Prisma.TaggedPagesCreateInput>[]
  ): PromiseLike<TaggedPages[]>;
  createForConnect(
...
> extends TaggedPagesFactoryInterfaceWithoutTraits {
  use(
    ...
    ...names: readonly TaggedPagesTraitKeys<TOptions>[]
  ): TaggedPagesFactoryInterfaceWithoutTraits;
}
/**
...
type PaymentMethodimageFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutPaymentMethodsInput['create']
  >;
};
type PaymentMethodFactoryDefineInput = {
  ...
  active?: boolean;
  image?:
    | PaymentMethodimageFactory
    | Prisma.ImageCreateNestedOneWithoutPaymentMethodsInput;
...
type PaymentMethodFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<PaymentMethodFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
type PaymentpaymentMethodFactory = {
  _factoryFor: 'PaymentMethod';
  build: () => PromiseLike<
    Prisma.PaymentMethodCreateNestedOneWithoutPaymentInput['create']
  >;
};
...
type PaymentTraitKeys<TOptions extends PaymentFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type PeerProfilelogoFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutPeerProfileLogoInput['create']
  >;
};
type PeerProfilesquareLogoFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutPeerProfileSquareLogoInput['create']
  >;
};
type PeerProfileFactoryDefineInput = {
  ...
  logo?:
    | PeerProfilelogoFactory
    | Prisma.ImageCreateNestedOneWithoutPeerProfileLogoInput;
  squareLogo?:
    | PeerProfilesquareLogoFactory
    | Prisma.ImageCreateNestedOneWithoutPeerProfileSquareLogoInput;
};
...
type PeerProfileTraitKeys<TOptions extends PeerProfileFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type PeerTraitKeys<TOptions extends PeerFactoryDefineOptions> =
  keyof TOptions['traits'];
export interface PeerFactoryInterfaceWithoutTraits {
  readonly _factoryFor: 'Peer';
  build(
    inputData?: Partial<Prisma.PeerCreateInput>
...
type TokenTraitKeys<TOptions extends TokenFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type SubscriptionPeriodinvoiceFactory = {
  _factoryFor: 'Invoice';
  build: () => PromiseLike<
    Prisma.InvoiceCreateNestedOneWithoutSubscriptionPeriodsInput['create']
  >;
};
type SubscriptionPeriodsubscriptionFactory = {
  _factoryFor: 'Subscription';
  build: () => PromiseLike<
    Prisma.SubscriptionCreateNestedOneWithoutPeriodsInput['create']
  >;
};
...
type SubscriptionPeriodFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<SubscriptionPeriodFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
type SubscriptionDeactivationsubscriptionFactory = {
  _factoryFor: 'Subscription';
  build: () => PromiseLike<
    Prisma.SubscriptionCreateNestedOneWithoutDeactivationInput['create']
  >;
};
...
type SubscriptionDeactivationFactoryDefineOptions = {
  defaultData: Resolver<
    SubscriptionDeactivationFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<SubscriptionDeactivationFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface SubscriptionDeactivationFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.SubscriptionDeactivationCreateInput>[]
  ): PromiseLike<Prisma.SubscriptionDeactivationCreateInput[]>;
  pickForConnect(
    inputData: SubscriptionDeactivation
  ): Pick<SubscriptionDeactivation, 'id'>;
  create(
    inputData?: Partial<Prisma.SubscriptionDeactivationCreateInput>
...
type SubscriptionpaymentMethodFactory = {
  _factoryFor: 'PaymentMethod';
  build: () => PromiseLike<
    Prisma.PaymentMethodCreateNestedOneWithoutSubscriptionInput['create']
  >;
};
type SubscriptionmemberPlanFactory = {
  _factoryFor: 'MemberPlan';
  build: () => PromiseLike<
    Prisma.MemberPlanCreateNestedOneWithoutSubscriptionInput['create']
  >;
};
type SubscriptionuserFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutSubscriptionsInput['create']
  >;
};
type SubscriptionreplacesSubscriptionFactory = {
  _factoryFor: 'Subscription';
  build: () => PromiseLike<
    Prisma.SubscriptionCreateNestedOneWithoutReplacedByInput['create']
  >;
};
type SubscriptionFactoryDefineInput = {
  ...
  user:
    ...
    | Prisma.UserCreateNestedOneWithoutSubscriptionsInput;
  replacesSubscription?:
    | SubscriptionreplacesSubscriptionFactory
    | Prisma.SubscriptionCreateNestedOneWithoutReplacedByInput;
...
type SubscriptionTraitKeys<TOptions extends SubscriptionFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type UserAddressUserFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutAddressInput['create']
  >;
};
...
type UserAddressTraitKeys<TOptions extends UserAddressFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type UserOAuth2AccountUserFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutOauth2AccountsInput['create']
  >;
};
type UserOAuth2AccountFactoryDefineInput = {
  ...
  User?:
    | UserOAuth2AccountUserFactory
    | Prisma.UserCreateNestedOneWithoutOauth2AccountsInput;
};
type UserOAuth2AccountFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<UserOAuth2AccountFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
type PaymentProviderCustomerUserFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutPaymentProviderCustomersInput['create']
  >;
};
...
type PaymentProviderCustomerFactoryDefineOptions = {
  defaultData?: Resolver<
    PaymentProviderCustomerFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<PaymentProviderCustomerFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface PaymentProviderCustomerFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.PaymentProviderCustomerCreateInput>[]
  ): PromiseLike<Prisma.PaymentProviderCustomerCreateInput[]>;
  pickForConnect(
    inputData: PaymentProviderCustomer
  ): Pick<PaymentProviderCustomer, 'id'>;
  create(
    inputData?: Partial<Prisma.PaymentProviderCustomerCreateInput>
...
type UseruserImageFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutUsersInput['create']
  >;
};
type UseraddressFactory = {
  _factoryFor: 'UserAddress';
  build: () => PromiseLike<
    Prisma.UserAddressCreateNestedOneWithoutUserInput['create']
  >;
};
type UserFactoryDefineInput = {
  ...
  userImage?:
    | UseruserImageFactory
    | Prisma.ImageCreateNestedOneWithoutUsersInput;
  address?:
    | UseraddressFactory
    | Prisma.UserAddressCreateNestedOneWithoutUserInput;
...
type UserRoleFactoryDefineInput = {
  ...
  name?: string;
  permissionIDs?:
    | Prisma.UserRoleCreatepermissionIDsInput
    | Prisma.Enumerable<string>;
  systemRole?: boolean;
};
...
type UserRoleTraitKeys<TOptions extends UserRoleFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type TagpeerFactory = {
  _factoryFor: 'Peer';
  build: () => PromiseLike<
    Prisma.PeerCreateNestedOneWithoutTagsInput['create']
  >;
};
...
type PollTraitKeys<TOptions extends PollFactoryDefineOptions> =
  keyof TOptions['traits'];
export interface PollFactoryInterfaceWithoutTraits {
  readonly _factoryFor: 'Poll';
  build(
    inputData?: Partial<Prisma.PollCreateInput>
...
type PollAnswerpollFactory = {
  _factoryFor: 'Poll';
  build: () => PromiseLike<
    Prisma.PollCreateNestedOneWithoutAnswersInput['create']
  >;
};
...
type PollAnswerTraitKeys<TOptions extends PollAnswerFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type PollVoteuserFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutPollVotesInput['create']
  >;
};
type PollVoteanswerFactory = {
  _factoryFor: 'PollAnswer';
  build: () => PromiseLike<
    Prisma.PollAnswerCreateNestedOneWithoutVotesInput['create']
  >;
};
type PollVotepollFactory = {
  _factoryFor: 'Poll';
  build: () => PromiseLike<
    Prisma.PollCreateNestedOneWithoutVotesInput['create']
  >;
};
type PollVoteFactoryDefineInput = {
  ...
  answer:
    | PollVoteanswerFactory
    | Prisma.PollAnswerCreateNestedOneWithoutVotesInput;
...
type PollVoteTraitKeys<TOptions extends PollVoteFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type PollExternalVoteSourcepollFactory = {
  _factoryFor: 'Poll';
  build: () => PromiseLike<
    Prisma.PollCreateNestedOneWithoutExternalVoteSourcesInput['create']
  >;
};
...
type PollExternalVoteSourceFactoryDefineOptions = {
  defaultData: Resolver<
    PollExternalVoteSourceFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<PollExternalVoteSourceFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface PollExternalVoteSourceFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.PollExternalVoteSourceCreateInput>[]
  ): PromiseLike<Prisma.PollExternalVoteSourceCreateInput[]>;
  pickForConnect(
    inputData: PollExternalVoteSource
  ): Pick<PollExternalVoteSource, 'id'>;
  create(
    inputData?: Partial<Prisma.PollExternalVoteSourceCreateInput>
...
type PollExternalVoteanswerFactory = {
  _factoryFor: 'PollAnswer';
  build: () => PromiseLike<
    Prisma.PollAnswerCreateNestedOneWithoutExternalVotesInput['create']
  >;
};
...
type PollExternalVoteFactoryDefineInput = {
  ...
  amount?: number;
  answer:
    | PollExternalVoteanswerFactory
    | Prisma.PollAnswerCreateNestedOneWithoutExternalVotesInput;
  source:
...
type PollExternalVoteFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<PollExternalVoteFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
type EventimageFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutEventsInput['create']
  >;
};
type EventFactoryDefineInput = {
  ...
  lead?: string | null;
  description?:
    | Prisma.EventCreatedescriptionInput
    | Prisma.Enumerable<Prisma.InputJsonValue>;
  status?: EventStatus;
...
type EventTraitKeys<TOptions extends EventFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type TaggedEventseventFactory = {
  _factoryFor: 'Event';
  build: () => PromiseLike<
    Prisma.EventCreateNestedOneWithoutTagsInput['create']
  >;
};
type TaggedEventstagFactory = {
  _factoryFor: 'Tag';
  build: () => PromiseLike<
    Prisma.TagCreateNestedOneWithoutEventsInput['create']
  >;
};
...
type TaggedEventsTraitKeys<TOptions extends TaggedEventsFactoryDefineOptions> =
  keyof TOptions['traits'];
export interface TaggedEventsFactoryInterfaceWithoutTraits {
  ...
  pickForConnect(
    inputData: TaggedEvents
  ): Pick<TaggedEvents, 'eventId' | 'tagId'>;
  create(
    inputData?: Partial<Prisma.TaggedEventsCreateInput>
...
type ConsentTraitKeys<TOptions extends ConsentFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type UserConsentconsentFactory = {
  _factoryFor: 'Consent';
  build: () => PromiseLike<
    Prisma.ConsentCreateNestedOneWithoutUserConsentsInput['create']
  >;
};
type UserConsentuserFactory = {
  _factoryFor: 'User';
  build: () => PromiseLike<
    Prisma.UserCreateNestedOneWithoutConsentsInput['create']
  >;
};
type UserConsentFactoryDefineInput = {
  ...
  value?: boolean;
  consent:
    | UserConsentconsentFactory
    | Prisma.ConsentCreateNestedOneWithoutUserConsentsInput;
...
type UserConsentTraitKeys<TOptions extends UserConsentFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type UserFlowMailmailTemplateFactory = {
  _factoryFor: 'MailTemplate';
  build: () => PromiseLike<
    Prisma.MailTemplateCreateNestedOneWithoutUserFlowMailsInput['create']
  >;
};
...
type UserFlowMailTraitKeys<TOptions extends UserFlowMailFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type SubscriptionFlowmemberPlanFactory = {
  _factoryFor: 'MemberPlan';
  build: () => PromiseLike<
    Prisma.MemberPlanCreateNestedOneWithoutSubscriptionFlowsInput['create']
  >;
};
type SubscriptionFlowFactoryDefineInput = {
  ...
  periodicities?:
    ...
    | Prisma.Enumerable<PaymentPeriodicity>;
  autoRenewal?:
    | Prisma.SubscriptionFlowCreateautoRenewalInput
    | Prisma.Enumerable<boolean>;
  memberPlan?:
...
type SubscriptionFlowFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<SubscriptionFlowFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
type SubscriptionIntervalsubscriptionFlowFactory = {
  ...
  build: () => PromiseLike<
    Prisma.SubscriptionFlowCreateNestedOneWithoutIntervalsInput['create']
  >;
};
...
type SubscriptionIntervalFactoryDefineOptions = {
  defaultData: Resolver<
    SubscriptionIntervalFactoryDefineInput,
    BuildDataOptions
  >;
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<SubscriptionIntervalFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface SubscriptionIntervalFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData:
      | number
      | readonly Partial<Prisma.SubscriptionIntervalCreateInput>[]
  ): PromiseLike<Prisma.SubscriptionIntervalCreateInput[]>;
  pickForConnect(
    inputData: SubscriptionInterval
  ): Pick<SubscriptionInterval, 'id'>;
  create(
    inputData?: Partial<Prisma.SubscriptionIntervalCreateInput>
...
type MailTemplateTraitKeys<TOptions extends MailTemplateFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type PeriodicJobTraitKeys<TOptions extends PeriodicJobFactoryDefineOptions> =
  keyof TOptions['traits'];
...
type BlockStyleTraitKeys<TOptions extends BlockStyleFactoryDefineOptions> =
  keyof TOptions['traits'];
export interface BlockStyleFactoryInterfaceWithoutTraits {
  readonly _factoryFor: 'BlockStyle';
  build(
    inputData?: Partial<Prisma.BlockStyleCreateInput>
  ): PromiseLike<Prisma.BlockStyleCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.BlockStyleCreateInput>
  ): PromiseLike<Prisma.BlockStyleCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.BlockStyleCreateInput>[]
  ): PromiseLike<Prisma.BlockStyleCreateInput[]>;
  pickForConnect(inputData: BlockStyle): Pick<BlockStyle, 'id'>;
  create(
    inputData?: Partial<Prisma.BlockStyleCreateInput>
  ): PromiseLike<BlockStyle>;
  createList(
    inputData: number | readonly Partial<Prisma.BlockStyleCreateInput>[]
  ): PromiseLike<BlockStyle[]>;
  createForConnect(
...
> extends BlockStyleFactoryInterfaceWithoutTraits {
  use(
    ...
    ...names: readonly BlockStyleTraitKeys<TOptions>[]
  ): BlockStyleFactoryInterfaceWithoutTraits;
}
/**
...
type BannerimageFactory = {
  _factoryFor: 'Image';
  build: () => PromiseLike<
    Prisma.ImageCreateNestedOneWithoutBannersInput['create']
  >;
};
...
type BannerTraitKeys<TOptions extends BannerFactoryDefineOptions> =
  keyof TOptions['traits'];
export interface BannerFactoryInterfaceWithoutTraits {
  readonly _factoryFor: 'Banner';
  build(
    inputData?: Partial<Prisma.BannerCreateInput>
  ): PromiseLike<Prisma.BannerCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.BannerCreateInput>
  ): PromiseLike<Prisma.BannerCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.BannerCreateInput>[]
  ): PromiseLike<Prisma.BannerCreateInput[]>;
...
> extends BannerFactoryInterfaceWithoutTraits {
  use(
    ...
    ...names: readonly BannerTraitKeys<TOptions>[]
  ): BannerFactoryInterfaceWithoutTraits;
}
/**
...
type BannerActionbannerFactory = {
  _factoryFor: 'Banner';
  build: () => PromiseLike<
    Prisma.BannerCreateNestedOneWithoutActionsInput['create']
  >;
};
type BannerActionFactoryDefineInput = {
  ...
  banner:
    | BannerActionbannerFactory
    | Prisma.BannerCreateNestedOneWithoutActionsInput;
};
...
type BannerActionTraitKeys<TOptions extends BannerActionFactoryDefineOptions> =
  keyof TOptions['traits'];
export interface BannerActionFactoryInterfaceWithoutTraits {
  readonly _factoryFor: 'BannerAction';
  build(
    inputData?: Partial<Prisma.BannerActionCreateInput>
  ): PromiseLike<Prisma.BannerActionCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.BannerActionCreateInput>
  ): PromiseLike<Prisma.BannerActionCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.BannerActionCreateInput>[]
  ): PromiseLike<Prisma.BannerActionCreateInput[]>;
  pickForConnect(inputData: BannerAction): Pick<BannerAction, 'id'>;
  create(
    inputData?: Partial<Prisma.BannerActionCreateInput>
  ): PromiseLike<BannerAction>;
  createList(
    inputData: number | readonly Partial<Prisma.BannerActionCreateInput>[]
  ): PromiseLike<BannerAction[]>;
  createForConnect(
...
> extends BannerActionFactoryInterfaceWithoutTraits {
  use(
    ...
    ...names: readonly BannerActionTraitKeys<TOptions>[]
  ): BannerActionFactoryInterfaceWithoutTraits;
}
/**
...
type CrowdfundingTraitKeys<TOptions extends CrowdfundingFactoryDefineOptions> =
  keyof TOptions['traits'];
export interface CrowdfundingFactoryInterfaceWithoutTraits {
  readonly _factoryFor: 'Crowdfunding';
  build(
    inputData?: Partial<Prisma.CrowdfundingCreateInput>
  ): PromiseLike<Prisma.CrowdfundingCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.CrowdfundingCreateInput>
  ): PromiseLike<Prisma.CrowdfundingCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.CrowdfundingCreateInput>[]
  ): PromiseLike<Prisma.CrowdfundingCreateInput[]>;
  pickForConnect(inputData: Crowdfunding): Pick<Crowdfunding, 'id'>;
  create(
    inputData?: Partial<Prisma.CrowdfundingCreateInput>
  ): PromiseLike<Crowdfunding>;
  createList(
    inputData: number | readonly Partial<Prisma.CrowdfundingCreateInput>[]
  ): PromiseLike<Crowdfunding[]>;
  createForConnect(
...
> extends CrowdfundingFactoryInterfaceWithoutTraits {
  use(
    ...
    ...names: readonly CrowdfundingTraitKeys<TOptions>[]
  ): CrowdfundingFactoryInterfaceWithoutTraits;
}
/**
...
type CrowdfundingGoalCrowdfundingFactory = {
  ...
  build: () => PromiseLike<
    Prisma.CrowdfundingCreateNestedOneWithoutGoalsInput['create']
  >;
};
type CrowdfundingGoalFactoryDefineInput = {
  ...
  amount?: number;
  Crowdfunding:
    | CrowdfundingGoalCrowdfundingFactory
    | Prisma.CrowdfundingCreateNestedOneWithoutGoalsInput;
};
type CrowdfundingGoalFactoryDefineOptions = {
  ...
  traits?: {
    [traitName: string | symbol]: {
      data: Resolver<
        Partial<CrowdfundingGoalFactoryDefineInput>,
        BuildDataOptions
      >;
    };
  };
...
export interface CrowdfundingGoalFactoryInterfaceWithoutTraits {
  ...
  build(
    inputData?: Partial<Prisma.CrowdfundingGoalCreateInput>
  ): PromiseLike<Prisma.CrowdfundingGoalCreateInput>;
  buildCreateInput(
    inputData?: Partial<Prisma.CrowdfundingGoalCreateInput>
  ): PromiseLike<Prisma.CrowdfundingGoalCreateInput>;
  buildList(
    inputData: number | readonly Partial<Prisma.CrowdfundingGoalCreateInput>[]
  ): PromiseLike<Prisma.CrowdfundingGoalCreateInput[]>;
  pickForConnect(inputData: CrowdfundingGoal): Pick<CrowdfundingGoal, 'id'>;
  create(
    inputData?: Partial<Prisma.CrowdfundingGoalCreateInput>
  ): PromiseLike<CrowdfundingGoal>;
  createList(
    inputData: number | readonly Partial<Prisma.CrowdfundingGoalCreateInput>[]
  ): PromiseLike<CrowdfundingGoal[]>;
  createForConnect(
...
> extends CrowdfundingGoalFactoryInterfaceWithoutTraits {
  use(
    ...
    ...names: readonly CrowdfundingGoalTraitKeys<TOptions>[]
  ): CrowdfundingGoalFactoryInterfaceWithoutTraits;
}
/**
