...
type MetadataPropertyTraitKeys<TOptions extends MetadataPropertyFactoryDefineOptions> =
...
type ArticleRevisionTraitKeys<TOptions extends ArticleRevisionFactoryDefineOptions> =
  keyof TOptions['traits']
...
type ArticleRevisionAuthorTraitKeys<TOptions extends ArticleRevisionAuthorFactoryDefineOptions> =
  keyof TOptions['traits']
...
type ArticleTrackingPixelsTraitKeys<TOptions extends ArticleTrackingPixelsFactoryDefineOptions> =
  keyof TOptions['traits']
export interface ArticleTrackingPixelsFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData: number | readonly Partial<Prisma.ArticleTrackingPixelsCreateInput>[]
  ): PromiseLike<Prisma.ArticleTrackingPixelsCreateInput[]>
...
type TrackingPixelMethodTraitKeys<TOptions extends TrackingPixelMethodFactoryDefineOptions> =
  keyof TOptions['traits']
export interface TrackingPixelMethodFactoryInterfaceWithoutTraits {
  ...
  buildList(
    inputData: number | readonly Partial<Prisma.TrackingPixelMethodCreateInput>[]
  ): PromiseLike<Prisma.TrackingPixelMethodCreateInput[]>
...
type TaggedArticlesTraitKeys<TOptions extends TaggedArticlesFactoryDefineOptions> =
  keyof TOptions['traits']
...
type TaggedAuthorsTraitKeys<TOptions extends TaggedAuthorsFactoryDefineOptions> =
  keyof TOptions['traits']
...
type CommentsRevisionsTraitKeys<TOptions extends CommentsRevisionsFactoryDefineOptions> =
  keyof TOptions['traits']
...
type TaggedCommentsTraitKeys<TOptions extends TaggedCommentsFactoryDefineOptions> =
  keyof TOptions['traits']
...
type CommentRatingSystemTraitKeys<TOptions extends CommentRatingSystemFactoryDefineOptions> =
  keyof TOptions['traits']
...
type CommentRatingTraitKeys<TOptions extends CommentRatingFactoryDefineOptions> =
  keyof TOptions['traits']
...
type CommentRatingOverrideTraitKeys<TOptions extends CommentRatingOverrideFactoryDefineOptions> =
  keyof TOptions['traits']
...
type AvailablePaymentMethodTraitKeys<TOptions extends AvailablePaymentMethodFactoryDefineOptions> =
  keyof TOptions['traits']
...
type NavigationLinkTraitKeys<TOptions extends NavigationLinkFactoryDefineOptions> =
  keyof TOptions['traits']
 ...
 */
export declare function defineTaggedPagesFactory<TOptions extends TaggedPagesFactoryDefineOptions>(
  options: TOptions
): TaggedPagesFactoryInterface<TOptions>
...
type PaymentMethodTraitKeys<TOptions extends PaymentMethodFactoryDefineOptions> =
  keyof TOptions['traits']
...
type SubscriptionPeriodTraitKeys<TOptions extends SubscriptionPeriodFactoryDefineOptions> =
  keyof TOptions['traits']
...
type UserOAuth2AccountTraitKeys<TOptions extends UserOAuth2AccountFactoryDefineOptions> =
  keyof TOptions['traits']
...
type PollExternalVoteSourceTraitKeys<TOptions extends PollExternalVoteSourceFactoryDefineOptions> =
  keyof TOptions['traits']
...
type PollExternalVoteTraitKeys<TOptions extends PollExternalVoteFactoryDefineOptions> =
  keyof TOptions['traits']
...
type SubscriptionFlowTraitKeys<TOptions extends SubscriptionFlowFactoryDefineOptions> =
  keyof TOptions['traits']
...
type SubscriptionIntervalTraitKeys<TOptions extends SubscriptionIntervalFactoryDefineOptions> =
  keyof TOptions['traits']
 ...
 */
export declare function defineBlockStyleFactory<TOptions extends BlockStyleFactoryDefineOptions>(
  options?: TOptions
): BlockStyleFactoryInterface<TOptions>
 ...
 */
export declare function defineBannerFactory<TOptions extends BannerFactoryDefineOptions>(
  options?: TOptions
): BannerFactoryInterface<TOptions>
...
type CrowdfundingGoalTraitKeys<TOptions extends CrowdfundingGoalFactoryDefineOptions> =
  keyof TOptions['traits']
