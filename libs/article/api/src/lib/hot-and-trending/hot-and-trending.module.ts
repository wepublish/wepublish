...
export interface HotAndTrendingClientAsyncOptions extends Pick<ModuleMetadata, 'imports'> {
  useExisting?: Type<HotAndTrendingOptionsFactory>
  useClass?: Type<HotAndTrendingOptionsFactory>
  useFactory?: (...args: any[]) => Promise<HotAndTrendingDataSource> | HotAndTrendingDataSource
  inject?: any[]
}
...
export class HotAndTrendingModule {
  ...
  public static registerAsync(options: HotAndTrendingClientAsyncOptions): DynamicModule {
    return {
      module: HotAndTrendingModule,
  ...
  private static createAsyncProviders(options: HotAndTrendingClientAsyncOptions): Provider[] {
  ...
  private static createAsyncOptionsProvider(options: HotAndTrendingClientAsyncOptions): Provider {
