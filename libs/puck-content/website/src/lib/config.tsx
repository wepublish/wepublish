...
import { seoFieldAi } from '@wepublish/puck-content/editor';
  ...
  root: {
    fields: {
      ...
      seo: {
        ...
        ai: {
          ...seoFieldAi,
          instructions: `Metadata shown to search engines. ${seoFieldAi.instructions}`,
        },
      },
      socialMedia: {
        type: 'seo',
        ai: {
          ...seoFieldAi,
          instructions: `Metadata shown when the page is shared on social media. ${seoFieldAi.instructions}`,
        },
      },
    },
    defaultProps: {
