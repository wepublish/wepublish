...
export class NavigationDataloaderService implements Primeable<Navigation> {
  ...
  public prime(
    ...parameters: Parameters<DataLoader<string, Navigation | null>['prime']>
  ) {
    return this.dataloader.prime(...parameters);
  }

  public load(
    ...parameters: Parameters<DataLoader<string, Navigation | null>['load']>
  ) {
    return this.dataloader.load(...parameters);
  }

  public loadMany(
    ...parameters: Parameters<DataLoader<string, Navigation | null>['loadMany']>
  ) {
