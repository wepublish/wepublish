...
export interface GoogleAnalyticsAsyncOptions extends Pick<ModuleMetadata, 'imports'> {
  useExisting?: Type<GoogleAnalyticsOptionsFactory>
  useClass?: Type<GoogleAnalyticsOptionsFactory>
  useFactory?: (...args: any[]) => Promise<GoogleAnalyticsConfig> | GoogleAnalyticsConfig
  inject?: any[]
}
...
export class GoogleAnalyticsModule {
  ...
  public static registerAsync(options: GoogleAnalyticsAsyncOptions): DynamicModule {
    return {
      module: GoogleAnalyticsModule,
  ...
  private static createAsyncProviders(options: GoogleAnalyticsAsyncOptions): Provider[] {
  ...
  private static createAsyncOptionsProvider(options: GoogleAnalyticsAsyncOptions): Provider {
