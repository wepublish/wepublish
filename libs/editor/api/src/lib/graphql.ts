...
export const MemberPlanListDocument = gql`
    query MemberPlanList($filter: MemberPlanFilter, $cursor: String, $take: Int, $skip: Int) {
  memberPlans(filter: $filter, cursor: $cursor, take: $take, skip: $skip) {
    nodes {
      ...FullMemberPlan
    }
    pageInfo {
