...
export type TrackingPixelFragment = { __typename?: 'TrackingPixel', id: string, uri?: string | null, error?: string | null, trackingPixelProviderID: string, trackingPixelProviderType: TrackingPixelProviderType };
