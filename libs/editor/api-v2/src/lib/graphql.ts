...
export type BannersQuery = {
  ...
  banners: Array<{
    ...
    showOnPages?: Array<{__typename?: 'PageModel', id: string}> | null,
    image?: {
      __typename?: 'Image',
      id: string,
...
export type FullBannerActionFragment = {
  __typename?: 'BannerAction',
  id: string,
  label: string,
  url: string,
...
export type CreateBlockStyleMutation = {
  __typename?: 'Mutation',
  createBlockStyle: {
    __typename?: 'BlockStyle',
    id: string,
...
export type UpdateBlockStyleMutation = {
  __typename?: 'Mutation',
  updateBlockStyle: {
    __typename?: 'BlockStyle',
    id: string,
...
export type DeleteBlockStyleMutation = {
  __typename?: 'Mutation',
  deleteBlockStyle: {
    __typename?: 'BlockStyle',
    id: string,
...
export type FullConsentFragment = {
  __typename?: 'Consent',
  id: string,
  name: string,
  slug: string,
...
export type FullUserConsentFragment = {
  __typename?: 'UserConsent',
  id: string,
  value: boolean,
  createdAt: string,
  ...
  user: {__typename?: 'User', id: string, name: string, firstName?: string | null, email: string}
};

export type ConsentsQueryVariables = Exact<{[key: string]: never;}>;


export type ConsentsQuery = {
  __typename?: 'Query',
  consents: Array<{
    __typename?: 'Consent',
    id: string,
...
export type CreateUserConsentMutation = {
  __typename?: 'Mutation',
  createUserConsent: {
    __typename?: 'UserConsent',
    id: string,
...
export type DeleteUserConsentMutation = {
  __typename?: 'Mutation',
  deleteUserConsent: {
    __typename?: 'UserConsent',
    id: string,
...
export type ImportableEventRefFragment = {
  __typename?: 'EventFromSource',
  id: string,
  name: string,
...
export type ImportedEventListQuery = {
  __typename?: 'Query',
  importedEvents: {
    __typename?: 'ImportedEventsDocument',
    totalCount: number,
...
export type ImportedEventQuery = {
  __typename?: 'Query',
  importedEvent: {
    __typename?: 'EventFromSource',
    id: string,
...
export type MailTemplateQuery = {
  ...
  provider: {__typename?: 'MailProviderModel', name: string}
};
...
export type FullPeriodicJobFragment = {
  __typename?: 'PeriodicJob',
  id: string,
  date: string,
  error?: string | null,
  executionTime?: string | null,
  finishedWithError?: string | null,
  modifiedAt: string,
  successfullyFinished?: string | null,
  tries: number,
  createdAt: string
};
...
export type PeriodicJobLogsQuery = {
  __typename?: 'Query',
  periodicJobLog: Array<{
    __typename?: 'PeriodicJob',
    id: string,
    date: string,
    error?: string | null,
...
export type FullPollVoteFragment = {
  __typename?: 'PollVote',
  id: string,
  createdAt: string,
  pollId: string,
...
export type FullPollVoteWithAnswerFragment = {
  ...
  userId?: string | null,
  fingerprint?: string | null,
  answer: {__typename?: 'PollAnswerInVote', id: string, answer: string}
};
...
export type DeletePollVotesMutation = {
  __typename?: 'Mutation',
  deletePollVotes: {__typename?: 'DeletePollVotesResult', count: number}
};
...
export type SettingsListQuery = {
  ...
  settings: Array<{
    ...
    settingRestriction?: {
      ...
      allowedValues?: {
        __typename?: 'AllowedSettingVals',
        stringChoice?: Array<string> | null,
...
export type UpdateSettingMutation = {
  __typename?: 'Mutation',
  updateSetting: {__typename?: 'Setting', name: SettingName, value?: any | null}
};
...
export type SubscriptionFlowsQuery = {
  __typename?: 'Query',
  subscriptionFlows: Array<{
    __typename?: 'SubscriptionFlowModel',
    id: string,
    default: boolean,
    autoRenewal: Array<boolean>,
    periodicities: Array<PaymentPeriodicity>,
    ...
    intervals: Array<{
      ...
      event: SubscriptionEvent,
      mailTemplate?: {__typename?: 'MailTemplateRef', id: string, name: string} | null
    }>
  }>
};
...
export type CreateSubscriptionFlowMutation = {
  __typename?: 'Mutation',
  createSubscriptionFlow: Array<{
    __typename?: 'SubscriptionFlowModel',
    id: string,
    default: boolean,
    autoRenewal: Array<boolean>,
...
export type UpdateSubscriptionFlowMutation = {
  __typename?: 'Mutation',
  updateSubscriptionFlow: Array<{
    __typename?: 'SubscriptionFlowModel',
    id: string,
    default: boolean,
    autoRenewal: Array<boolean>,
...
export type DeleteSubscriptionFlowMutation = {
  __typename?: 'Mutation',
...
export type CreateSubscriptionIntervalMutation = {
  __typename?: 'Mutation',
  createSubscriptionInterval: Array<{
    __typename?: 'SubscriptionFlowModel',
    id: string,
    default: boolean,
    autoRenewal: Array<boolean>,
...
export type UpdateSubscriptionIntervalMutation = {
  __typename?: 'Mutation',
  updateSubscriptionInterval: Array<{
    __typename?: 'SubscriptionFlowModel',
    id: string,
    default: boolean,
    autoRenewal: Array<boolean>,
...
export type DeleteSubscriptionIntervalMutation = {
  __typename?: 'Mutation',
  deleteSubscriptionInterval: Array<{
    __typename?: 'SubscriptionFlowModel',
    id: string,
    default: boolean,
    autoRenewal: Array<boolean>,
...
export type SubscriptionFlowFragment = {
  __typename?: 'SubscriptionFlowModel',
  id: string,
  default: boolean,
  autoRenewal: Array<boolean>,
...
export type SubscriptionIntervalFragment = {
  __typename?: 'SubscriptionInterval',
  id: string,
  daysAwayFromEnding?: number | null,
  event: SubscriptionEvent,
...
export type FullAvailablePaymentMethodFragment = {
  __typename?: 'AvailablePaymentMethod',
  paymentPeriodicities: Array<PaymentPeriodicity>,
  forceAutoRenewal: boolean,
  paymentMethods: Array<{
...
export type UpdateSystemMailMutation = {
  __typename?: 'Mutation',
  updateSystemMail: Array<{
    __typename?: 'SystemMailModel',
    event: UserEvent,
    mailTemplate?: {__typename?: 'MailTemplateRef', id: string, name: string} | null
  }>
...
export type SystemMailFragment = {
  __typename?: 'SystemMailModel',
  event: UserEvent,
  mailTemplate?: {__typename?: 'MailTemplateRef', id: string, name: string} | null
};
