...
import {TeaserSlotsAutofillConfig} from '@wepublish/editor/api'

interface TeaserSlotsDialogProps {
  config: TeaserSlotsAutofillConfig
  open: boolean
  onOpenChange: (open: boolean) => void
  onSave: (config: TeaserSlotsAutofillConfig) => void
  onCancel: () => void
  children?: ReactNode
}
...
export function TeaserSlotsAutofillDialog({
  ...
  const [localConfig, setLocalConfig] = useState<TeaserSlotsAutofillConfig>({...config})
