...
export const RatingWrapper = styled('div')<Partial<RatingProps>>`
  ...
  .average-rating {
    & .MuiRating-iconFilled {
      color: ${({theme, averageFilledColor}) => averageFilledColor || theme.palette.primary.main};
    }

    & .MuiRating-iconEmpty {
      color: ${({theme, averageEmptyColor}) => averageEmptyColor || theme.palette.grey[400]};
    }
  }
  ...
  .user-rating {
    ...
    & .MuiRating-iconFilled {
      color: ${({theme, userFilledColor}) => userFilledColor || theme.palette.primary.main};
    }
